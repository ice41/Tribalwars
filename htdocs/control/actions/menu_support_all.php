...
<form action="menu.php?screen=support&amp;mode=<?=$_GET['mode'];?>&amp;action=mdel" method="POST">
	<table width="99%" class="vis"  style="border-spacing:1px; background-color:#FEE47D;" align="center">
		<tr><th colspan="5"><div align="center">Todos os tickets</div></th></tr>
		<tr>
...
<?
	$sql = $db->query("SELECT * FROM `support` ORDER BY `u_resp` DESC");
...
?>
<table class="vis" width="99%" style="border-spacing:1px; background-color:#FEE47D;" align="center">
...
<table class="vis" width="99%" id="resp_row" style="display:none;border-spacing:1px; background-color:#FEE47D;" align="center">
