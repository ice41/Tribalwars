...
{if $village.$screen > 0}
	<table class="vis">
		...
		<tr>
			<td width="200">
				<img src="graphic/{$sur_name}.png" alt="" />
				{$lev.opis}
			</td>
			<td>
				<b>{$lev.produkcja}</b>
	...
	<table class="vis">
		...
		<tr>
			...
			<td>
				<img src="graphic/holz.png" title="Drewno" alt="" /> {$p_wood}
				<img src="graphic/lehm.png" title="Glina" alt="" />{$p_stone}
				<img src="graphic/eisen.png" title="¯elazo" alt="" />{$p_iron}
			</td>
		</tr>
		<tr>
			<td colspan="2">
