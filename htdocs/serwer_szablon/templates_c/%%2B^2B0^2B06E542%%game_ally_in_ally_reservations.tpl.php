<?php /* Smarty version 2.6.14, created on 2012-01-30 16:40:05
...
" method="post">
				<table class="vis" style="width: 100%;">
					...
					<thead>
						<tr class="nowrap">
							<th><img src="graphic/delete.png" title="Usuñ kilka naraz" alt="Usuñ kilka naraz"></th>
							<th>Nazwa wioski</th>
							<th>Punkty</th>
							<th>W³aœciciel</th>
...
">
									<img src="graphic/oben.png" alt="Sortuj rosn¹co" title="Sortuj rosn¹co">
								</a> 
								<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=reservations&amp;page=<?php echo $this->_tpl_vars['aktupage']; ?>
&amp;sort=od_gname&amp;order=DESC&filter=<?php echo $this->_tpl_vars['filter']; ?>
">
									<img src="graphic/unten.png" alt="Sortuj malej¹co" title="Sortuj malej¹co">
								</a>
							</th>
							<th>Data wygaœniêcia 
								<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
"><?php echo $this->_tpl_vars['info']['od_allyname']; ?>
								...
								<td style="white-space: nowrap;">
									<img src="graphic/show_comment_disabled.png" alt="Brak komentarzy" title="Brak komentarzy">
									<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=map&amp;x=<?php echo $this->_tpl_vars['info']['village']['x']; ?>
&amp;y=<?php echo $this->_tpl_vars['info']['village']['y']; ?>
">
										<img src="graphic/map_center.png" alt="Scentruj mapê" title="Scentruj mapê">
									</a>
									<?php if ($this->_tpl_vars['is_user_admin']): ?>
										<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
&filter=<?php echo $this->_tpl_vars['filter']; ?>
">
											<img src="graphic/delete.png" alt="Skasuj" title="Skasuj">
										</a>
									<?php endif; ?>
								</td>
							</tr>
...
">
					...
					<span style="font-weight:bold; color: #804000; cursor: pointer;" onclick="insertUnit(document.forms['rezerwacje'].typ_akcji,'add_new');document.forms['rezerwacje'].submit();">
						<img src="graphic/plus.png" alt="Dodaj nastêpn¹ rezerwacjê" title="Dodaj nastêpn¹ rezerwacjê">
