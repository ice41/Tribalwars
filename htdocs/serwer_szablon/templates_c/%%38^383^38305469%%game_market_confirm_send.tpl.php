...
<td width="200"><?php if ($this->_tpl_vars['confirm']['wood'] > 0): ?><img src="graphic/holz.png" title="Holz" alt="" /><?php echo $this->_tpl_vars['confirm']['wood']; ?>
 ...
 <?php endif; ?></td></tr>
<tr><td>Potrzeba kupców:</td><td><?php echo $this->_tpl_vars['confirm']['dealers']; ?>
</td></tr>
...
<tr><td>Powrót:</td><td><?php echo $this->_tpl_vars['pl']->pl_date($this->_tpl_vars['confirm']['time_back']); ?>
</td></tr>
</table><br />
