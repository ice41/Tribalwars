					...
					<div class="container-block">
						...
						<div class="container">
								...
								<div>
														...
														<br>	<b>Existem <?php echo $this->_tpl_vars['players']; ?>
 Contas registadas!</b>
										   							</div>
	   							<div class="clear"></div>
							</div>
...
<script type="text/javascript">
    GAPageTracking.track({ page_identifier : "index", page_type : "game"});
</script>
...
?>
							<div>
								<span class="<?php if ($this->_tpl_vars['ogloszenie']['typ'] != 0): ?>global-<?php endif; ?>news"><?php echo $this->_tpl_vars['ogloszenie']['nazwa']; ?>
</span>
...
\">\n\n\t\t\n\t<div id=\"active_server\">\n\t\t\t\t\t<p class=\"pseudo-heading\">Em que mundo quer entrar?<\/p>\n\t\t\t\t\t\t\t<div class=\"clearfix\"><?php $_from = $this->_tpl_vars['serwery']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['serw']):
?>\n\t\t\t\t\t\t<a href=\"#\" onclick=\"return Index.submit_login('serwer=<?php echo $this->_tpl_vars['serw']; ?>
');\">\n\t\t\t\t<span class=\"world_button_<?php if (! in_array ( $this->_tpl_vars['serwer'] , $this->_tpl_vars['user_info']['serwery_gry'] )): ?>in<?php endif; ?>active\">Mundo <?php echo $this->_tpl_vars['serw']; ?>
<\/span>\n\t\t\t<\/a><?php endforeach; endif; unset($_from); ?>\n\t\t\t\t\t\t<\/div>\n\t\t\n\t\t\n\t\t\t\t\t<p class=\"pseudo-heading\" id=\"show_all_server\">\n\t\t\t\t<?php if ($this->_tpl_vars['user_info']['admin'] == 0): ?><a href=\"admin.php\">Entrar como admin<\/a>\n\t\t\t<\/p>\n\t\t    <\/div>\n\n    \t<div id=\"inactive_server_list\" class=\"clearfix\" style=\"display:none;\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t<\/div><?php endif; ?>\n\t\n\t\n<\/form>\n\n"}
