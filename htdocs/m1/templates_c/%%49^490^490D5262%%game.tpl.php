<?php /* Smarty version 2.6.14, created on 2016-12-22 21:33:18
         compiled from ../templates/game.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'format_number', '../templates/game.tpl', 145, false),)), $this); ?>
<?php 
...
$this->_smarty_include(array('smarty_include_tpl_file' => "game_ann_delete.tpl", 'smarty_include_vars' => array()));
...
<?php 
 ...
 ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "game_ann_sleep.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php 
...
<?php 
 ...
 ?>
<body onload="<?php if(isset($onload)){foreach($onload as $test){$count = $i++ + 1;if($count>1){echo ",".$test;}else{echo $test;}}} ?>">
...
" cellspacing="0">
	<tr id="menu_row">
		<td height="24"><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=&amp;action=logout&amp;h=<?php echo $this->_tpl_vars['hkey']; ?>
" target="_top">Sair</a></div></td>
...
&amp;screen=settings">Configura&ccedil;&otilde;es</a></div>
			<table cellspacing="0" width="150">
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=profile">&raquo; Perfil</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=settings">&raquo; Configura&ccedil;&otilde;es</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=email">&raquo; Endere&ccedil;o de e-mail</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=change_passwd">&raquo; Trocar senha</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=start">&raquo; Recome&ccedil;ar</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=delete">&raquo; Apagar conta</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=quickbar">&raquo; Editar barra de acesso r&aacute;pido</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=share">&raquo; Compartilhar conex&atilde;o à internet</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=vacation">&raquo; Modo de f&eacute;rias</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=logins">&raquo; Acessos</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=sleep">&raquo; Modo noturno</a></td></tr>
			</table>
		</td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking">Ranking</a> <b>(<?php echo $this->_tpl_vars['user']['rang']; ?>
.|<?php echo ((is_array($_tmp=$this->_tpl_vars['user']['points'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
 P)</b></div>
			<table cellspacing="0" width="150">
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking&amp;mode=ally">&raquo; Tribos</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking&amp;mode=player">&raquo; Jogadores</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking&amp;mode=kill_player">&raquo; Oponentes derrotados</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking&amp;mode=hives">&raquo; Saqueadores</a></td></tr>
			</table>
		</td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally">Tribo</a></div>
			<?php if ($this->_tpl_vars['user']['ally'] != -1): ?>
				<table cellspacing="0" width="150">
					<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=overview">&raquo; Visualiza&ccedil;&atilde;o geral</a></td></tr>
					<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=profile">&raquo; Perfil</a></td></tr>
					<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=members">&raquo; Membros</a></td></tr>
					<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=ally&mode=contracts">&raquo; Diplomacia</a></td></tr>
					<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=ally&mode=reservations">&raquo; Reserva de aldeias</a></td></tr>
					<?php if ($this->_tpl_vars['user']['ally_invite'] == 1): ?><tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=invite">&raquo; Convites</a></td></tr><?php endif; ?>
					<?php if ($this->_tpl_vars['user']['ally_lead'] == 1): ?><tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=ally&mode=intro_igm">&raquo; Bem vindo</a></td></tr><?php endif; ?>
					<?php if ($this->_tpl_vars['user']['ally_diplomacy'] == 1): ?><tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=properties">&raquo; Propriedades</a></td></tr><?php endif; ?>
					<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=forum">&raquo; F&oacute;rum da tribo</a></td></tr>
				</table>
			<?php endif; ?>
		</td>
		<td <?php if ($this->_tpl_vars['user']['new_report'] == 1): ?>class="new_report"<?php endif; ?>><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report"><?php if ($this->_tpl_vars['user']['new_report'] == 1): ?><img src="../graphic/icons/new_rep.png" title="Novo relat&oacute;rio" alt="" /><?php endif; ?> Relat&oacute;rios</a></div>
			<table cellspacing="0" width="150">
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=all">&raquo; Todos os relat&oacute;rios</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=attack">&raquo; Ataques</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=defense">&raquo; Defesa</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=support">&raquo; Apoio</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=trade">&raquo; Mercado</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=other">&raquo; Outros</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=public_reports">&raquo; Relat&oacute;rios publicados</a></td></tr>
			</table>
		</td>
		<td <?php if ($this->_tpl_vars['user']['new_mail'] == 1): ?>class="new_mail"<?php endif; ?>><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail"><?php if ($this->_tpl_vars['user']['new_mail'] == 1): ?><img src="../graphic/icons/new_mail.png" title="Nova mensagem" alt="" /><?php endif; ?> Mensagens</a></div>
			<table cellspacing="0" width="150">
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail&amp;mode=in">&raquo; Mensagens</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail&amp;mode=new">&raquo; Escrever mensagem</a></td></tr>
				<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail&amp;mode=block">&raquo; Bloquear remetente</a></td></tr>
			</table>
		</td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=memo">Notas</a></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=friends">Amigos</a></div></td>
	</tr>
</table><br />
<?php if ($this->_tpl_vars['user']['show_toolbar'] == 1): ?>
	<?php require_once(SMARTY_CORE_DIR . 'core.smarty_include_php.php');
smarty_core_smarty_include_php(array('smarty_file' => "quickbar.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<tr>
		<td align="left">
			<table class="menu nowrap" cellspacing="0">
				<tr id="menu_row2">
					<td height="24"><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages" accesskey="s">Visualiza&ccedil;&atilde;o</a></div>
						<table cellspacing="0" width="150">
							<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages&amp;mode=combined">&raquo; Combinado</a></td></tr>
							<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages&amp;mode=prod">&raquo; Produ&ccedil;&atilde;o</a></td></tr>
							<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages&amp;mode=units">&raquo; Tropas</a></td></tr>
							<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages&amp;mode=commands">&raquo; Comandos</a></td></tr>
							<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages&amp;mode=incomings">&raquo; Chegando</a></td></tr>
							<tr><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages&amp;mode=rename">&raquo; Renoemar aldeias</a></td></tr>
						</table>
					</td>
					<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=map">Mapa</a></div></td>
				...
				<tr>
					<td>
						<table class="box" cellspacing="0">
							<tr>
								<td height="24"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=wood"><img src="../graphic/icons/wood.png" title="Madeira" alt="" /></a></td>
...
&amp;screen=stone"><img src="../graphic/icons/stone.png" title="Argila" alt="" /></a></td>
...
" <?php if ($this->_tpl_vars['village']['r_stone'] == $this->_tpl_vars['max_storage']): ?>class="warn"<?php endif; ?>><?php echo $this->_tpl_vars['village']['r_stone']; ?>
								...
								<td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=iron"><img src="../graphic/icons/iron.png" title="Ferro" alt="" /></a></td>
...
&amp;screen=storage"><img src="../graphic/icons/storage.png" title="Armaz&eacute;m" /></a>
								</td>
								<td><div id="storage" style="display:none;"><?php echo $this->_tpl_vars['max_storage']; ?>
</div><b><?php echo $this->_tpl_vars['max_storage']; ?>
</b>&nbsp;</td>
							</tr>
						</table>
						...
						<table class="box" cellspacing="0">
							<tr>
								<td width="18" height="24" align="center">
									<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=farm"><img src="../graphic/icons/farm.png" title="Fazenda" alt="" /></a>
								</td>
								<td align="center"><b><?php echo $this->_tpl_vars['village']['r_bh']; ?>
...
" target="_top">Sair</a></div></td>
		...
		<td><div align="center"><a href="help.php" target="_blank">Ajuda</a></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings">Configura&ccedil;&otilde;es</a></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=premium">Premium</a></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking">Ranking</a> <b>(<?php echo $this->_tpl_vars['user']['rang']; ?>
.|<?php echo ((is_array($_tmp=$this->_tpl_vars['user']['points'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
 P)</b></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally">Tribo</a></div></td>
		<td <?php if ($this->_tpl_vars['user']['new_report'] == 1): ?>class="new_report"<?php endif; ?>><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report"><?php if ($this->_tpl_vars['user']['new_report'] == 1): ?><img src="../graphic/icons/new_rep.png" title="Novo relat&oacute;rio" alt="" /><?php endif; ?> Relat&oacute;rios</a></div></td>
		<td <?php if ($this->_tpl_vars['user']['new_mail'] == 1): ?>class="new_mail"<?php endif; ?>><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail"><?php if ($this->_tpl_vars['user']['new_mail'] == 1): ?><img src="../graphic/icons/new_mail.png" title="Nova mensagem" alt="" /><?php endif; ?> Mensagens</a></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=memo">Notas</a></div></td>
		<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=friends">Amigos</a></div></td>
	...
	<tr>
		<td align="left">
			<table class="menu nowrap" cellspacing="0">
				<tr id="menu_row2">
					<td height="24"><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview_villages" accesskey="s">Visualiza&ccedil;&atilde;o</a></div></td>
					<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=map">Mapa</a></div></td>
					<td><div align="center"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=overview"><?php echo $this->_tpl_vars['village']['name']; ?>
			...
			<table cellspacing="0">
				<tr>
					<td>
						<table class="box" cellspacing="0">
							<tr>
								<td width="30" height="24" class="att">(<?php echo $this->_tpl_vars['user']['attacks']; ?>
)</td>
							</tr>
						</table>
					</td>
...
<?php 
 ...
 ?>
				...
				<tr><th colspan="2" style="text-align:center;"><a href="<?php echo $uri; ?>&hide=<?php echo $this->_tpl_vars['hkey']; ?>
">Ocultar | [v2.1] | Hide</a></th></tr>
			</table>
		</td>
	</tr>
</table><br />
...
" align="center">
	<tr>
		<td style="padding:2px;">
			<?php if ($this->_tpl_vars['screen'] == 'train'): ?>
				<?php require_once(SMARTY_CORE_DIR . 'core.smarty_include_php.php');
smarty_core_smarty_include_php(array('smarty_file' => "actions/train.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<tr>
		<th <?php if ($this->_tpl_vars['screen'] != 'overview' || $this->_tpl_vars['screen'] != 'overview_villages'): ?>colspan="2"<?php endif; ?>><span style="float:right;">Gerado em <?php echo $this->_tpl_vars['load_msec']; ?>
ms | Hora do Servidor: <span id="serverTime"><?php echo $this->_tpl_vars['servertime']; ?>
</span> | <?php echo date("d.m.Y"); ?></span></th>
	</tr>
</table>
<table class="corp" style="width:<?php echo $this->_tpl_vars['user']['window_width']; ?>
px;" align="center">
	<tr>
		<td class="corp_s"></td>
...
<?php 
 ...
 ?>
			<div class="noob">Sua prote&ccedil;&atilde;o acaba em <b><?php echo date("d.m.Y, H:i", $user['noob_protection']); ?></b> | Tempo restante: <b><span class="timer"><?php echo format_time($noob_end); ?></span></b></div>
<?php 
	}
 ?>
		</td>
...
<table class="main" width="<?php echo $this->_tpl_vars['user']['window_width']; ?>
" align="center">
	<tr><th style="text-align:center;">&copy;<?php echo date('Y'); ?> | Empire of War - Todos os direitos reservados - <a href="http://LanServers.tk" target="_blank">LanServers</a></th></tr>
</table>
<div id="footer">
	<div id="linkContainer" style="max-width:<?php echo $this->_tpl_vars['user']['window_width']; ?>
px; min-width:250px;">
		<div id="footer_left">
			<a href="http://lanservers.tk" target="_blank">F&oacute;rum</a> - 
			<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=support">Suporte</a> - 
			<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=settings&amp;mode=profile">Perfil</a>
		</div>
		<div id="footer_right">
			<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
