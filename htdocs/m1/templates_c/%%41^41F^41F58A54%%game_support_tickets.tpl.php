<?php /* Smarty version 2.6.14, created on 2016-12-22 21:37:16
         compiled from game_support_tickets.tpl */ ?>
...
&amp;screen=support&amp;mode=tickets&amp;view=<?php echo $ticket['id']; ?>"><?php echo entparse($ticket['subject']);if($count > 0){echo " ("; echo $count+1; echo ")";} ?></a></td>
		<td align="center"><a href="#"><?php echo entparse($ticket['username']); ?></a><br /><b class="small"><?php echo date('d.m.Y H:i', $ticket['time']); ?></b></td>
		<td align="center">
			<?php  if($n_rsp != 0){  ?>
				<?php  if($rsp_ticket['userid'] == '-1'){  ?>
			<b><?php echo entparse($rsp_ticket['username']); ?></b><br /><b class="small"><?php echo date('d.m.Y H:i', $rsp_ticket['time']); ?></b>
				<?php  }else{  ?>
			<a href="#"><?php echo entparse($rsp_ticket['username']); ?></a><br /><b class="small"><?php echo date('d.m.Y H:i', $rsp_ticket['time']); ?></b>
				<?php  }  ?>
			<?php  }else{  ?>
				--
			<?php  }  ?>
...
<table class="vis" width="100%" style="border-spacing: 1px; background-color: #FEE47D; border:1px solid #fee47d;-moz-border-radius:5px 5px 5px 5px;-webkit-border-top-left-radius:5px;-webkit-border-top-right-radius:5px;-webkit-border-bottom-left-radius:5px;-webkit-border-bottom-right-radius:5px;" align="center">
	<tr><th colspan="2"><div align="center"><?php echo entparse($ticket['subject']); ?></div></td></tr>
	<tr>
		<td width="10%">Tipo:</td>
		<td><?php echo entparse($ticket['type']); ?></td>
	</tr>
	<tr>
		<td>Data:</td>
...
&amp;screen=support&amp;mode=tickets&amp;view=<?php echo $_GET['view']; ?>&amp;p=1">&lt;&lt;</a> | 
<?php 
	}
 ...
 ?>
			<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=support&amp;mode=tickets&amp;view=<?php echo $_GET['view']; ?>&amp;p=<?php echo $i; ?>">[<?php echo $i; ?>]</a>
<?php 
		}
	}
 ?>
...
<?php 
 ...
 ?>
			 | <a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=support&amp;mode=tickets&amp;view=<?php echo $_GET['view']; ?>&amp;p=<?php echo $pags; ?>">&gt;&gt;</a>
<?php 
	}
 ?>
		</td>
 ...
 ?>
			<div class="post"> 
				<div class="igmline small">
					<?php  if($r_ticket['userid'] == '-1'){  ?>
					<span class="author"><b><?php echo urldecode($r_ticket['username']); ?></b></span> 
					<?php  }else{  ?>
					<span class="author"><a href="#"><?php echo urldecode($r_ticket['username']); ?></a></span> 
					<?php  }  ?>
					<span class="date"><?php echo date("d.m.Y H:i", $r_ticket['time']); ?></span>
				</div>
				<div class="text"><?php echo bb_format(wordwrap(nl2br(entparse($r_ticket['text'])), 88, "<br />", true)); ?></div> 
			</div>
<?php 
		}
 ...
 ?>
			...
			<div class="post"> 
				<div class="igmline small"> 
					<span class="author"><a href="#"><?php echo entparse($ticket['username']); ?></a></span>
					<span class="date"><?php echo date('d.m.Y H:i', $ticket['time']); ?></span>
				</div> 
				<div class="text"><?php echo bb_format(wordwrap(nl2br(entparse($ticket['text'])), 88, "<br />", true)); ?></div> 
			</div>
<?php 
		}
 ?>
...
<?php if($ticket['stat'] == '0' || $ticket['stat'] == '1'){ ?>
...
&amp;screen=support&amp;mode=tickets&amp;view=<?php echo $ticket['id']; ?>&action=resp">
		<tr>
			<td><strong>Situa&ccedil;&atilde;o:</strong></td>
			<td><label><input type="checkbox" name="stat" <?php if($ticket['stat'] == '2'){ ?>checked="checked"<?php } ?> /> Resolvido</label></td>
		</tr>
		<tr>
			<td colspan="2"> 
