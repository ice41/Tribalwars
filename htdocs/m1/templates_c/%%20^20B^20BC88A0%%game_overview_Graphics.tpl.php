<?php /* Smarty version 2.6.14, created on 2016-12-22 21:33:20
         compiled from game_overview_Graphics.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'format_time', 'game_overview_Graphics.tpl', 1151, false),array('modifier', 'replace', 'game_overview_Graphics.tpl', 1271, false),array('modifier', 'format_date', 'game_overview_Graphics.tpl', 1272, false),)), $this); ?>
<?php 
...
<?php 
 ...
 ?>
					...
					<th><center><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=overview&overview=old">Visualiza&ccedil;&atilde;o cl&aacute;ssica da aldeia</a></center></th>
				</tr>
			</table><br />
...
" class="label_<?php echo $this->_tpl_vars['dbname']; ?>
">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
...
<?php 
					if($n_main > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_main; ?></span></span>
<?php 
					}
 ?>
								</div>
...
<?php 
						if($n_barracks > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_barracks; ?></span></span>
<?php 
						}
 ?>
								</div>
...
<?php 
 ...
 ?>
							<div id="label_barracks" class="label_barracks">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $barracks_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
						if($n_stable > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_stable; ?></span></span>
<?php 
						}
 ?>
								</div>
...
<?php 
 ...
 ?>
							<div id="label_stable" class="label_stable">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $stable_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
						if($n_garage > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_garage; ?></span></span>
<?php 
						}
 ?>
								</div>
...
<?php 
 ...
 ?>
							<div id="label_garage" class="label_garage">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $garage_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
						if($n_snob > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_snob; ?></span></span>
<?php 
						}
 ?>
								</div>
...
<?php 
 ...
 ?>
							<div id="label_snob" class="label_snob">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $snob_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
						if($n_smith > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_smith; ?></span></span>
<?php 
						}
 ?>
								</div>
...
<?php 
 ...
 ?>
							<div id="label_smith" class="label_smith">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $smith_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
 ...
 ?>
							<div id="label_place" class="label_place">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $place_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
						if($n_statue > 0){
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $aus_statue; ?></span></span>
<?php 
						}
 ?>
								</div>
...
<?php 
 ...
 ?>
							<div id="label_statue" class="label_statue">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $statue_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
 ...
 ?>
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><?php echo $dealers_in;  ?>/<?php echo $arr_dealers[$market]; ?></span>
								</div>
							</div>
<?php 
					endif;
 ...
 ?>
							<div id="label_market" class="label_market">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $market_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
 ...
 ?>
							<div id="label_wood" class="label_wood">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $wood_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
 ...
 ?>
							<div id="label_stone" class="label_stone">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $stone_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<?php 
 ...
 ?>
							<div id="label_iron" class="label_iron">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $iron_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
<br />
										...
										<?php if ($this->_tpl_vars['wood_sec'] == '0' && $this->_tpl_vars['stone_sec'] == '0' && $this->_tpl_vars['iron_sec'] == '0'): ?>
											<!--span style="font-size:7px;font-weight:bold;color:#E41B17;"> CHEIO </span-->
										<?php elseif ($this->_tpl_vars['wood_sec'] > $this->_tpl_vars['stone_sec']): ?>
										...
										<?php elseif ($this->_tpl_vars['stone_sec'] > $this->_tpl_vars['iron_sec']): ?>
										...
										<?php elseif ($this->_tpl_vars['iron_sec'] > $this->_tpl_vars['wood_sec']): ?>
										...
										<?php elseif ($this->_tpl_vars['wood_sec'] > $this->_tpl_vars['iron_sec']): ?>
											<span class="timer"><?php echo ((is_array($_tmp=$this->_tpl_vars['wood_sec'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</span> 
										<?php elseif ($this->_tpl_vars['iron_sec'] > $this->_tpl_vars['stone_sec']): ?>
											<span class="timer"><?php echo ((is_array($_tmp=$this->_tpl_vars['iron_sec'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</span> 
										<?php elseif ($this->_tpl_vars['stone_sec'] > $this->_tpl_vars['wood_sec']): ?>
											<span class="timer"><?php echo ((is_array($_tmp=$this->_tpl_vars['stone_sec'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</span> 
										<?php elseif ($this->_tpl_vars['stone_sec'] == $this->_tpl_vars['wood_sec']): ?>
											<span class="timer"><?php echo ((is_array($_tmp=$this->_tpl_vars['stone_sec'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
...
<?php 
 ...
 ?>
							<div id="label_hide" class="label_hide">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $hide_end; ?></span></span>
								</div>
							</div>
<?php 
					endif;
...
<?php 
 ...
 ?>
							<div id="label_wall" class="label_wall">
								<div class="<?php echo $this->_tpl_vars['label']; ?>
">
									<span style="font-size:7px;font-weight:bold;color:#FFFFFF;"><span class="timer"><?php echo $wall_end; ?></span></span>
								</div>
							</div>
<?php 
							endif;
...
">cancelar</a></td>
		...
		<?php endif; ?>
		<?php if (count ( $this->_tpl_vars['other_movements'] ) > 0): ?><br />
<?php 
