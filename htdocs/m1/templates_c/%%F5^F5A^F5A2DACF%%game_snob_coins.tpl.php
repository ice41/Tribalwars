<?php /* Smarty version 2.6.14, created on 2016-12-22 21:34:55
         compiled from game_snob_coins.tpl */ ?>
<?php 
...
<table class="vis" style="border-spacing: 1px; background-color: #FEE47D; border:1px solid #fee47d;-moz-border-radius:5px 5px 5px 5px;-webkit-border-top-left-radius:5px;-webkit-border-top-right-radius:5px;-webkit-border-bottom-left-radius:5px;-webkit-border-bottom-right-radius:5px; margin-top:5px;">
	...
	<tr><td>Total de moedas:</td><td><?php  echo $taleri['coins'];  ?></td></tr>
	<tr><td>Limite de Nobres:</td><td><?php  echo $taleri['nextsnob'];  ?></td></tr>
	<tr>
		<td>Falta ainda para o limite de <?php echo $taleri['nextsnob']+1; ?> nobres:</td>
		<td><?php echo ($taleri['nextsnob']-$taleri['coins_n']); ?> moedas de ouro</td>
	</tr>
	<tr><td>J&aacute; guardadas para o limite de <?php echo $taleri['nextsnob']+1; ?> nobres:</td><td><?php echo $taleri['coins_n']; ?> moedas de ouro</td></tr>
</table><br />
...
<span style="float:right;"><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=overview_villages&mode=prod&action=reload_res">&raquo; Recarregar recursos</a></span>
<form action="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=snob&mode=coins&action=create" method="POST">
