...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'game_report_view.tpl', 102, false),)), $this); ?>
<?php 
...
&screen=report&mode=all&view=<?php echo $_GET['view']; ?>&public=do" method="post"> 
	...
	<tr>
		<td>
			<table class="vis">
				<tr>
					<th width="140">Relat&oacute;rio</th>
					<th width="400"><?php echo ((is_array($_tmp=$this->_tpl_vars['report']['title'])) ? $this->_run_mod_handler('replace', true, $_tmp, "graphic/", "../graphic/") : smarty_modifier_replace($_tmp, "graphic/", "../graphic/")); ?>
</th>
				</tr>
				<tr>
					<td>Recebido em</td>
			...
			<table class="vis">
				<tr>
 					<td colspan="2" valign="top" height="160" style="border:1px solid #FEE47D; padding:4px;-moz-border-radius:5px 5px 5px 5px;-webkit-border-top-left-radius:5px;-webkit-border-top-right-radius:5px;-webkit-border-bottom-left-radius:5px;-webkit-border-bottom-right-radius:5px;"> 
						...
						<p>O relat&oacute;rio foi publicado. Para ver o relat&oacute;tio utilize o link: <a href="http://<?php echo $_SERVER['SERVER_NAME'].dirname($_SERVER["REQUEST_URI"])."/public_reports.php?report_id=".$_GET['view']; ?>">http://<?php echo $_SERVER['SERVER_NAME'].dirname($_SERVER["REQUEST_URI"])."/public_reports.php?report_id=".$_GET['view']; ?></a></p> 
						Copie e cole r&aacute;pidamente: <input type="text" size="50" onclick="this.select(); this.focus()" value="http://<?php echo $_SERVER['SERVER_NAME'].dirname($_SERVER["REQUEST_URI"])."/public_reports.php?report_id=".$_GET['view']; ?>"/><br />
						<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=report&mode=public_reports">&raquo; Relat&oacute;rio publicados</a>
					</td>
				</tr>
			</table>
		</td>
		...
		<tr>
			<td>
				<table align="center" class="vis" width="100%">
					<tr>
						<td align="center" <?php if ($this->_tpl_vars['report']['type'] != 'attack'): ?>colspan="2"<?php endif; ?> width="20%">
							<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
">Apagar</a>
						...
						<?php if ($this->_tpl_vars['report']['type'] == 'attack'): ?>
						<?php $id = $_GET['view']; ?>
						<td align="center" width="20%">
							<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=report&amp;mode=<?php echo $this->_tpl_vars['mode']; ?>
&amp;view=<?php echo $id; ?>&public=options">Publicar relat&oacute;rio</a>
						</td>
						<?php endif; ?>
					</tr>
					<tr>
