<?php /* Smarty version 2.6.14, created on 2022-11-26 16:32:23
         compiled from game_settings_sleep.tpl */ ?>
<?php 
...
<b style="color: red;">ATEN&Ccedil;&Atilde;O:</b> Esta op&ccedil;&atilde;o pode ser usada:
	<li style="margin-left:15px;">A cada <?php  echo "<b>".$ase."</b>";  ?> minuto(s).</li>
	<li style="margin-left:15px;">Ap&oacute;s <?php  echo "<b>".$config['sleep_last_attack']."</b>";  ?> minuto(s) do &uacute;ltimo ataque.</li>
	<li style="margin-left:15px;">Ap&oacute;s <?php  echo "<b>".$config['sleep_noob_interval']."</b>";  ?> minuto(s) do fim da prote&ccedil;&atilde;o de iniciantes.</li>
	<li style="margin-left:15px;">Quando voc&ecirc; n&atilde;o estiver sendo atacado ou atacando alguem.</li><br />
<form action="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=settings&mode=sleep&sleep=go" method="POST">
	<table class="vis" width="50%" style="border-spacing: 1px; background-color: #FEE47D; border:1px solid #fee47d;-moz-border-radius:5px 5px 5px 5px;-webkit-border-top-left-radius:5px;-webkit-border-top-right-radius:5px;-webkit-border-bottom-left-radius:5px;-webkit-border-bottom-right-radius:5px;"
		<tr><th width="200">Dura&ccedil;&atilde;o m&aacute;xima:</th><td width="200"><b><?php  echo format_time($selectare['0']);  ?></b></td></tr>
		<?php  if($selectare['sleep_time'] > 0) {  ?>
		<?php  if($end_time < time() AND $end_time > 1) {  ?>
		<tr><th>Fim:</th><td><b><?php  echo date("d.m.Y, H:i", $end_time);  ?></b></td></tr>
		<?php  }  ?>
		<?php  if($last_attack_query['last_attack'] > 0) {
		 ...
		 ?>
		<?php if($user['sleep_last_activate'] != '0'){ ?><tr><th>&Uacute;ltima vez que usou:</th><td><b><?php  echo date("d.m.Y, H:i",$user['sleep_last_activate']);  ?></b></td></tr> <?php  } else { echo '<tr><td colspan="2"><b><span style="color: rgb(14, 255, 14);">Nunca usou</span></b></td></tr>'; } ?>
