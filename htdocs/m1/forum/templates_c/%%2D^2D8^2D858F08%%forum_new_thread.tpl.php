<?php /* Smarty version 2.6.14, created on 2011-08-16 20:44:58
         compiled from forum_new_thread.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'nl2br', 'forum_new_thread.tpl', 9, false),)), $this); ?>
...
<?php elseif ($this->_tpl_vars['thread_preview']): ?>
	<tr><td colspan="2" valign="top" style="background-color: white; border: solid 1px black;">
<?php echo ((is_array($_tmp=$this->_tpl_vars['thread_text'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

	</td></tr>
<?php endif; ?>
	<tr>
		<td>Nume</td><td><input name="thread_name" type="text" size="40" value="<?php echo $this->_tpl_vars['thread_name']; ?>
"/></td>
	</tr>
	<tr id="bbcode">
		<td></td>
	...
	<tr>
		<td>Text:</td><td><textarea id="message" name="thread_text" rows="10" cols="80"><?php echo $this->_tpl_vars['thread_text']; ?>
</textarea></td>
	</tr>
	<tr>
		<td colspan="100%">
