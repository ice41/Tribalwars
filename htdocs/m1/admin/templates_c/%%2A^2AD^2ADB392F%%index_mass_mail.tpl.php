<?php /* Smarty version 2.6.14, created on 2012-11-14 12:01:52
         compiled from index_mass_mail.tpl */ ?>
...
<br />
	...
	<span style="color: green;"><b><?php echo $this->_tpl_vars['succes']; ?>
</b></span>
</div>
<form method="post" action="index.php?screen=mass_mail&action=send">
	<div align="center">
	    <table class="vis">
		<tr>
	        <td width="150"><b>Expeditor:</b></td><td width="485"><input type="text" name="from" size="70" value="<?php echo $this->_tpl_vars['from_default']; ?>
"></td>
	      </tr>
	      <tr>
	        <td width="150"><b>Titlu:</b></td><td width="485"><input type="text" name="subject" size="70"></td>
	      </tr>
