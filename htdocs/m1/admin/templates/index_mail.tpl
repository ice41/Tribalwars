<h2 align="center">Server mesaj</h2>
<div align="center">De aici trimiti mesaj tuturor jucatorilor de pe server!<br />
  <br />

{if !empty($error)}
<br />
	<font class="error">{$error|replace:"Keinen Text angegeben!":"Trebuie sa aibe un text!"|replace:"Keinen Betreff angegeben!":"Trebuie sa aibe si un titlu!"}</font><br />
	<br />
{/if}
{if $is_send}
...
<form method="post" action="index.php?screen=mail&amp;action=send" onSubmit="this.submit.disabled=true;">
	<div align="center">
	    <table width="547" class="vis">
	      <tr>
	        <td width="50">Titlu:</td><td width="485"><input type="text" name="subject" size="70" value="{$subject}"></td>
	      </tr>
		  <tr id="bbcode">
        <td colspan="2">
	      ...
	      <tr>
	        <td colspan="2"><textarea id="message" rows="16" cols="80" name="text">{$text}</textarea></td>
	      </tr>
		    <tr>
