...
{else}
	{if empty($error)}
		...
		<td align="center" width="120">{if $mail.from_id==-1}Nie przeczytane{else}<a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=new&amp;reply={$mail.id}">Odpisz</a>{/if}</td>
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=new&amp;reply={$mail.id}&amp;forward=true">Napisz</a></td>
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=arch">Archiwum</a></td>
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;action=del&amp;id={$mail.id}&amp;mode=arch&amp;h={$hkey}">Usuñ</a></td>
		</tr>
		</table>
		...
		<tr><td>Sata</td><td>{$mail.time}</td></tr>
		</table>
