...
<tr><td>Sprzedawca:</td><td>{if $report.sell_ress=='wood'}<img src="graphic/holz.png" title="Drewno" alt="" />{/if}{if $report.sell_ress=='stone'}<img src="graphic/lehm.png" title="Glina" alt="" />{/if}{if $report.sell_ress=='iron'}<img src="graphic/eisen.png" title="¯elazo" alt="" />{/if}{$report.sell}</td>
<tr><td>Kupiec:</td><td>{if $report.buy_ress=='wood'}<img src="graphic/holz.png" title="Drewno" alt="" />{/if}{if $report.buy_ress=='stone'}<img src="graphic/lehm.png" title="Glina" alt="" />{/if}{if $report.buy_ress=='iron'}<img src="graphic/eisen.png" title="¯elazo" alt="" />{/if}{$report.buy}</td>
</table><br />
