<?php /* Smarty version 2.6.14, created on 2012-01-25 17:38:47
...
<table style="margin:auto; margin-top: 25px; border:1px solid brown; width: 100%;background:url(graphic/background/main_bg.jpg);">
	<tr>
		<td>

			<table id="content_value" style="background:url(graphic/background/main_bg.jpg);" cellspacing="0">
				<tr>
					<td>

<h1><img src="graphic/rabe_38x40.png" alt="" /> Uczestnictwo</h1>
