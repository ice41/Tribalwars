<?php /* Smarty version 2.6.14, created on 2011-12-26 17:23:52
...
?>
				<?php if ($this->_tpl_vars['id']['own_units'][$this->_tpl_vars['dbname']] == 0): ?>
						<td class="hidden"><?php echo $this->_tpl_vars['id']['own_units'][$this->_tpl_vars['dbname']]; ?>
</td>
				<?php else: ?>
						<td><?php echo $this->_tpl_vars['id']['own_units'][$this->_tpl_vars['dbname']]; ?>
</td>
				<?php endif; ?>
			<?php endforeach; endif; unset($_from); ?>
