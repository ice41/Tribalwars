...
<a href="game.php?village={$village.id}&amp;screen=support&do=new"><img style="border:1px;" src="graphic/ticket_new.png" /></a>  <h5>Ticketele tale</h5>	<tr>
		<th>Subiect</th>
		<th>Mesaj</th>
		<th>Trimis</th>
	</tr>
...
if ($_GET['do'] == 'new'){
    {/php}
<br />
<form method=post action="game.php?village={$village.id}&screen=support&do=new&send">
