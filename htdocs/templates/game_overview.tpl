...
<td align="right"><a href="game.php?overview=old&screen=overview&village={php}echo $_GET[village];{/php}">Privirea clasica asupra satului</a></td>
...
"/>
						{php} endif; {/php}
						{php} if ($this->_tpl_vars['dbname'] == 'statue'): {/php}
							<area shape="poly" coords="277,231,256,265,266,285,292,287,306,266" href="game.php?village={php} echo $this->_tpl_vars['village']['id']; {/php}
&screen={php} echo $this->_tpl_vars['dbname']; {/php}
" alt="{php} echo $this->_tpl_vars['cl_builds']->get_name($this->_tpl_vars['dbname']); {/php}
" title="{php} echo $this->_tpl_vars['cl_builds']->get_name($this->_tpl_vars['dbname']); {/php}
"/>
...
" /> {php} echo $this->_tpl_vars['village'][$this->_tpl_vars['dbname']]; {/php}
		...
		<td valign="top" width="100%">
			<table class="vis"  width="200" style="border:1px solid #804000;">
				...
				<tr class="mery"><td width="60"><img src="graphic/holz.png" title="Lemn" alt="" /> Lemn</td><td><strong>{php} echo $this->_tpl_vars['wood_prod_overview']; {/php}
</strong> / {php} if ($this->_tpl_vars['speed'] > 10): {/php}min{php} else: {/php}ora{php} endif; {/php}</td></tr>
				<tr class="mery"><td><img src="graphic/lehm.png" title="Argil&#259;" alt="" /> Argil&#259;</td><td><strong>{php} echo $this->_tpl_vars['stone_prod_overview']; {/php}
</strong> / {php} if ($this->_tpl_vars['speed'] > 10): {/php}min{php} else: {/php}ora{php} endif; {/php}</td></tr>
				<tr class="mery"><td><img src="graphic/eisen.png" title="Fier" alt="" /> Fier</td><td><strong>{php} echo $this->_tpl_vars['iron_prod_overview']; {/php}
</strong> / {php} if ($this->_tpl_vars['speed'] > 10): {/php}min{php} else: {/php}ora{php} endif; {/php}</td></tr>
			</table>
			<br />
...
.png"> <b>{php} echo $this->_tpl_vars['num']; {/php}
                ...
                {php} endforeach; endif; unset($_from); {/php}
                                  ...
                                  <table class="vis" width="100%" style="border: 1px solid rgb(128, 64, 0);">
				  <tr>
				    <td><a href="game.php?village={$village.id}&screen=barracks&mode=massrek">&raquo; recrutare &#238;n mas&#259;</a></td>
				  </tr>
				</table>
			<br />
			{php} if ($this->_tpl_vars['village']['agreement'] != '100'): {/php}
				<table class="vis" width="100%" style="border: 1px solid rgb(128, 64, 0);">
				<tr><th>Adeziune:</th><th>{php} echo $this->_tpl_vars['village']['agreement']; {/php}
</th></tr>
				</table>
				<br />
			{php} endif; {/php}
...
.png"> {php} echo $this->_tpl_vars['array']['message']; {/php}
				        ...
				        {php} else: {/php}
				        	<td><span class="">{php} echo ((is_array($_tmp=$this->_tpl_vars['array']['arrival_in'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); {/php}
</span></td>
				        {php} endif; {/php}
				    </tr>
				{php} endforeach; endif; unset($_from); {/php}
...
">intrerupe</a></td>
			...
			{php} endif; {/php}
				  ...
				  {/foreach}
				  <tr>
				    <td><a href="javascript:popup_scroll('groups.php?mode=village&amp;village_id={$village.id}&amp;hkey={$hkey}', 280, 250);">&raquo; modific&#259;</a></td>
				  </tr>
				</table>
...
<h2>Privire general&#259; asupra satului {php} echo $this->_tpl_vars['village']['name']; {/php}
</h2>
<table>
	<tr>
...
</a> (Nivelul {php} echo $this->_tpl_vars['village'][$this->_tpl_vars['dbname']]; {/php}
)</td>{php} if ($this->_tpl_vars['dbname'] == "market") { /*echo "<td><strong>Negustor: 8/10</strong></td>";*/ } {/php}
					</tr>
				{php} endforeach; endif; unset($_from); {/php}
			</table>
<br><a href="game.php?overview=new&screen=overview&village={php}echo $_GET[village];{/php}">spre privirea grafic&#259; asupra satului</a>
		</td>
		<td valign="top">
			<table class="vis" width="100%" style="border: 1px solid rgb(128, 64, 0);">
				<tr><th colspan="2">Produc&#355;ie</th></tr>
				<tr><td width="70"><img src="graphic/holz.png" title="Lemn" alt="" /> Lemn</td><td><strong>{php} echo $this->_tpl_vars['wood_prod_overview']; {/php}
</strong> pe {php} if ($this->_tpl_vars['speed'] > 10): {/php}minut{php} else: {/php}ora{php} endif; {/php}</td></tr>
				<tr><td><img src="graphic/lehm.png" title="Argila" alt="" /> Argil&#259;</td><td><strong>{php} echo $this->_tpl_vars['stone_prod_overview']; {/php}
</strong> pe {php} if ($this->_tpl_vars['speed'] > 10): {/php}minut{php} else: {/php}ora{php} endif; {/php}</td></tr>
				<tr><td><img src="graphic/eisen.png" title="Fier" alt="" /> Fier</td><td><strong>{php} echo $this->_tpl_vars['iron_prod_overview']; {/php}
</strong> pe {php} if ($this->_tpl_vars['speed'] > 10): {/php}minut{php} else: {/php}ora{php} endif; {/php}</td></tr>
			</table>
			<br />
			<table class="vis" width="100%" style="border: 1px solid rgb(128, 64, 0);">
