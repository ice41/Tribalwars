...
<table class="vis" width="450">
	...
	{foreach from=$announcement item=item key=f_id}
		<tr>
			...
			<td><a href="index.php?screen=startpage&action=drop&id={$announcement.$f_id.id}">Sterge</td>
		</tr>
	{/foreach}
</table>
<br /><br />
...
<table class="vis">
	...
	<tr>
		...
		<td><input type="radio" name="login_locked" value="yes" {if $login.login_locked=='yes'}checked{/if}> Da<br /><input type="radio" name="login_locked" value="no" {if $login.login_locked=='no'}checked{/if}> Nu</td>
	</tr>
	<tr>
