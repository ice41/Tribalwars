<?php /* Smarty version 2.6.14, created on 2012-04-28 18:55:15
...
&amp;screen=info_player&amp;id=<?php echo $id_all_activ[$key]; ?>"><?php echo $nume_user_pending ?></a></td> 
	<td><?php if ($online=='y') { echo '<center><img src="graphic/user_online.png" alt="online" title="online"></center>'; } elseif ($online=='n') { echo '<center><img src="graphic/user_offline.png" alt="offline" title="offline"></center>';} ?></td>
        <td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=friends&amp;action=delete_buddy&amp;buddy_id=<?php echo $value ?>" onclick="return confirm('Are you shure you want to delete this player from your friends list?')">Sterge</a></td> 
</tr> 
<?php } ?>
</table> 
<?php } ?>
...
&amp;screen=info_player&amp;id=<?php echo $id_to_pending[$key] ?>"><?php echo $nume_user_pending ?></a></td> 
	<td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=friends&amp;action=cancel_buddy&amp;buddy_id=<?php echo $value ?>" onclick="return confirm('Are you shure you want to delete your request?')">Retragere</a></td> 
</tr> 
<?php } ?>
</table> 
<?php } ?>
...
&amp;screen=info_player&amp;id=<?php echo $id_from_pending_request[$key]; ?>"><?php echo $nume_user_pending ?></a></td> 
	<td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=friends&amp;action=approve_buddy&amp;buddy_id=<?php echo $value ?>" onclick="return confirm('Are you shure you want to accept the request?')">Accepta</a></td> 
	<td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=friends&amp;action=reject_buddy&amp;buddy_id=<?php echo $value ?>" onclick="return confirm('Are you shure you want to deny the request?')">Refuza</a></td> 
</tr> 
<?php } ?>
</table> 
<?php } ?>
