<?php /* Smarty version 2.6.14, created on 2012-12-30 10:59:46
...
" type="checkbox" />
			        <?php if ($this->_tpl_vars['arr']['is_read'] == 0): ?> <img src="../graphic/new_mail.png" width="15" height="10" /><?php endif;  if ($this->_tpl_vars['arr']['is_read'] == 1): ?> <span class="inactive"><img src="../graphic/read_mail.png" width="15" height="10" /></span><?php endif; ?> <a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
">Sterge</a></td>
		...
		<tr><td>Expeditor</td><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
&amp;mode=out">Blocheaz&#259; expeditor</a></td>
		</tr>
		</table><br />
