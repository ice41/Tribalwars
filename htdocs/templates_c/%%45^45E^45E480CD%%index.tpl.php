<?php /* Smarty version 2.6.14, created on 2011-12-16 18:05:37
...
?>
        			<a onclick="insertUnit(document.forms['wys'].serwer,<?php echo $this->_tpl_vars['serwer']; ?>
						...
						<span class="world_button_<?php if (! in_array ( $this->_tpl_vars['serwer'] , $this->_tpl_vars['user_info']['serwery_gry'] )): ?>in<?php endif; ?>active">
							Świat <?php echo $this->_tpl_vars['serwer']; ?>
...
<div class="login-block logged_in">
    <h2 style="text-align:left;">Witaj <?php echo $this->_tpl_vars['user_info']['nazwa']; ?>
!</h2>
    <div class="ar_login">
...
</strong>? <a href="index.php?action=wyloguj">(Wyloguj)</a></p>
