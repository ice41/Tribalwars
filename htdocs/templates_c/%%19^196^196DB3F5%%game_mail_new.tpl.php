<?php /* Smarty version 2.6.14, created on 2012-12-29 04:13:31
...
<?php if ($this->_tpl_vars['preview']): ?>
    ...
    <?php  echo bb_format($this->_tpl_vars['preview_message']);  ?>
    </td></tr>
    </table><br />
<?php endif; ?>
...
" method="post">
  <table class="vis">
    <tbody>
      <tr><td>C&#259;tre:</td><td>
          <input type="text" name="to" size="50" value="<?php echo $this->_tpl_vars['inputs']['to']; ?>
" /><?php if ($this->_tpl_vars['user']['ally_mass_mail'] == 1 && $this->_tpl_vars['user']['ally'] != -1): ?>
          <a href="javascript:popup_scroll('igm_to.php?', 200, 280)">&raquo; Circular&#259;</a><?php endif; ?></td>
      </tr>
      <tr><td>Titlu:</td><td>
          <input type="text" name="subject" size="50" value="<?php echo $this->_tpl_vars['inputs']['subject']; ?>
" /></td>
      </tr>
    <tr id="bbcode">
        <td colspan="2">
        ...
        <tr>
            ...
            <td colspan="2">
                <textarea id="message" name="text" tabindex="3" cols="70" rows="16"><?php echo $this->_tpl_vars['inputs']['text']; ?>
</textarea>
            </td>
        </tr>
        <tr>
