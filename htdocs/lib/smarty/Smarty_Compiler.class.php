...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $template_header = "<?php /* Wersja Smarty_class ".$this->_version.", Plik stworzony ".strftime("%Y-%m-%d %H:%M:%S")."\n";
        $template_header .= "         Wersja PHP pliku pliki_tpl/".strtr(urlencode($resource_name), array('%2F'=>'/', '%3A'=>':'))." */ ?>\n";
