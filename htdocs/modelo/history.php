...
/*     PLIK: history.php   				            */
/*     DATA: 18.03.2012r        				    */
/*     ROLA: pokazuje histori� atakowanych wiosek	*/
/*     AUTOR: SIR ROLAND               				*/
/*==================================================*/
/****************************************************/
...
if (is_array($user_sid)) {
	$sql = mysql_query("SELECT wioska FROM `history` WHERE `graczid` = '".$user_sid['userid']."'");
...
<center>
	<table class="vis padding2" width="100%">
		<tr>
			<th height="20px">Histórico de seus pedidos:</th>
		</tr>
