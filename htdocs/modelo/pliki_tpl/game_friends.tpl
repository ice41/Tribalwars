...
<tr> 
	...
	<td>{php}if ($online=='y') { echo '<center><img src="/ds_graphic/user_online.png" alt="online" title="online"></center>'; } elseif ($online=='n') { echo '<center><img src="/ds_graphic/user_offline.png" alt="offline" title="offline"></center>';}{/php}</td>
        <td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=delete_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Are you shure you want to delete this player from your friends list?')">Excluir</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=approve_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Realmente quer aceitar esta proposta?')">Aceitar</a></td> 
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=reject_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Realmente deseja revogar esta proposta?')">Recusar</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
