...
<tr><td>Abreviatura:</td><td>{$info.short}</td></tr>
...
{if !empty($ally.irc)}
    <tr><td>IRC-Cancelar:</td><td>{$ally.irc}</td></tr>
{/if}
...
$cu_ce4 = Array(" foi fundada por ",". Se tiver uma pergunta, falar com ","<br/><br/><i>Este texto pode ser alterado pelos diplomatas da tribo.<i>");
