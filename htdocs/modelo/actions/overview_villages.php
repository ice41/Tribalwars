...
if ($_GET['mode'] === 'grocusto') {
	...
	if ($_GET['action'] == 'edit_grocusto' && count($_POST) > 0) {
		if ($_GET['h'] == $session['hkey']) {
			...
			header('location: game.php?village='.$village['id'].'&screen=overview_villages&mode=grocusto');
			exit;
			} else {
