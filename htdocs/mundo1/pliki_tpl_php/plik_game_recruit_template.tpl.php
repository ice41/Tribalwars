<?php /* Wersja Smarty_class 2.6.26 Przeróbka By Bartekst221, Plik stworzony 2023-02-26 22:48:37
         Wersja PHP pliku pliki_tpl/game_recruit_template.tpl */ ?>
...
.png" alt="" /> <?php echo $this->_tpl_vars['name']; ?>
					...
					<td><img src="/ds_graphic/face.png" title="População" alt="" /> <?php echo $this->_tpl_vars['cl_units']->get_bhprice($this->_tpl_vars['unit_dbname']); ?>
</td>
...
/<?php echo ((is_array($_tmp=$this->_tpl_vars['units_all'][$this->_tpl_vars['unit_dbname']])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
					...
					<?php elseif ($this->_tpl_vars['cl_units']->last_error == not_needed): ?>
					    <td class="inactive">Requisitos de construção não atendidos</td>
...
')">(<?php echo $this->_tpl_vars['cl_units']->last_error; ?>
		    ...
		    <tr><td colspan="8"align="right"><input name="submit" class="btn btn-recruit" type="submit" value="Recrutar" style="font-size: 10pt;" /></td></tr>
		</table>
	</form>
