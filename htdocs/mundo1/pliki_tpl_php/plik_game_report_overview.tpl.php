<?php /* Wersja Smarty_class 2.6.26 Przeróbka By Bartekst221, Plik stworzony 2023-02-26 21:19:58
         Wersja PHP pliku pliki_tpl/game_report_overview.tpl */ ?>
...
"><?php if ($this->_tpl_vars['reports'][$this->_tpl_vars['key']]['surowce'] && ! empty ( $this->_tpl_vars['reports'][$this->_tpl_vars['key']]['img'] )): ?><img src="../ds_graphic/max_loot/1.png" width="15" /><?php elseif (! $this->_tpl_vars['reports'][$this->_tpl_vars['key']]['surowce'] && ! empty ( $this->_tpl_vars['reports'][$this->_tpl_vars['key']]['img'] )): ?><img src="../ds_graphic/max_loot/0.png" width="15" /><?php endif; ?>
