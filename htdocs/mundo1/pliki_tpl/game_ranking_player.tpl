					...
					<tr>
						{if $aktu_page_ra > 0}
							<td align="center" width="50%">
								<a href="game.php?village={$village.id}&amp;screen=ranking&amp;mode=player&amp;page={$aktu_page_ra-1}">&lt;&lt;&lt; Anterior</a>
							</td>
						{/if}
						<td align="center" width="50%">
							<a href="game.php?village={$village.id}&amp;screen=ranking&amp;mode=player&amp;page={$aktu_page_ra+1}">Proximo &gt;&gt;&gt;</a>
						</td>
					</tr>
				</tbody>
			</table>
