...
<tr>		
		<td>Funkcje Premium</td>
				<td>
					...
					<b>Atenção! Números, conteúdo e custo do SMS<br> devem ser editados no arquivo htdocs/mundo{$serwerid}/lib/config.php</b>
				</td>				
			</tr>
			<tr>
				<td>Aldeias para começar [1-50] :</td>
...
<tr>		
		<td>Demolição de edifícios:</td>
			...
			<tr>
				...
				<b>Cor da linha de estatísticas:</b><br>
...
{if $serv.noc}			<tr>
				...
				<td><b>começo:<input type="text" name="noc_poczatek" value="{$serv.noc_poczatek}"> <br>Fim:<input type="text" name="noc_koniec" value="{$serv.noc_koniec}"></b></td>
			</tr>{/if}				
			<tr>
			...
			<tr>
				...
				<input type="text" name="mail_temat" value="{$serv.mail.temat}" size="30"> <b>O assunto da mensagem de boas-vindas</b><br> <b>Conteúdo da mensagem de boas-vindas:</b><br>
