...
if ($do=="reject_buddy"){
   ...
   if ($numar_control==1){
      ...
      if ($numar_control_block==0) {
         ...
         $titlu="$nume_player recusou o pedido de adição da lista de amigos";
...
if ($do=="approve_buddy"){
   ...
   if ($numar_control==1){
      ...
      $exec_sql2 = mysql_query($sql3) or die(mysql_error()); 
      $titlu="$nume_player aceitou o pedido de adição da lista de amigos";
...
if ($do=="delete_buddy"){
   ...
   if ($numar_control==1){
      ...
      if ($numar_control_block==0) {
         ...
         $titlu="$nume_player apagou da sua lista de amigos";
      ...
      header("Location: game.php?village=$id_sat&screen=friends&error=A entrada não existe!");
   }
...
if ($do=="add_buddy"){
   ...
   $error="O jogador $nume_adaugare não existe";
