...
/*ZDEFINIUJ ZMIENNE POCHODZ�CE OD USERA, KT�RE MOG� BY� AKCEPTOWANE*/
...
$modes = array(
	...
	'Mapa' => 'map',
	'Relatórios' => 'reports',
	'Tabela de pontos' => 'points',
	'codigo BB' => 'bb',
	'Informação do server' => 'server_info',
	'Exército' => 'units_faq',
	'Tribo' => 'ally_faq'
	);
...
if ($_GET['mode'] === 'server_info') {
	...
	if ($config['ag_style'] == 0) { 
		$tpl->assign('snob_text','Suma poziom�w pa�ac�w');
		}
	elseif ($config['ag_style'] == 1) {
		$tpl->assign('snob_text','Moedas de ouro');
		} else {
		$tpl->assign('snob_text','Sem dados');
		}
