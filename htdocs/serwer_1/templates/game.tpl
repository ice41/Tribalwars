...
<body style="margin-top:6px;">
	...
	<td><a href="game.php?village={$village.id}&amp;screen=settings">Ustawnienia</a>{if $user.dyn_menu==1}<br /><table cellspacing="0" width="120" class="menu"><tr><td><a href="game.php?village={$village.id}&amp;screen=settings&amp;mode=profile">Profil</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=settings&amp;mode=settings">Ustawienia</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=settings&amp;mode=vacation">Zastępstwo</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=settings&amp;mode=logins">Loginy</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=settings&amp;mode=change_passwd">Zmiana hasła</a></td></table>{/if}</td>
	<td><a href="game.php?village={$village.id}&amp;screen=ranking">Ranking</a> ({$user.rang}.|{$user.points|format_number} Pkt) {if $user.dyn_menu==1}<br /><table cellspacing="0" width="120" class="menu"><tr><td><a href="game.php?village={$village.id}&amp;screen=ranking&amp;mode=ally">Plemię</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=ranking&amp;mode=player">Gracz</a></td></tr></table>{/if}</td>
	<td> <a href="game.php?village={$village.id}&amp;screen=ally">Plemię</a>{if $user.dyn_menu==1}{if $user.ally!=-1}<br /><table cellspacing="0" width="120" class="menu"><tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=overview">Przegląd</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=profile">Profil</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=members">Członkowie</a></td></tr>{if $user.ally_invite==1}<tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=invites">Zaproszenia</a></td></tr>{/if}{if $user.ally_diplomacy==1}<tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=properties">Ustawnienia</a></td></tr>{/if}<tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=kontrakty">Dyplomacja</a></td></tr><tr><td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=reservations">Planer podbojów</a></td></tr></table>{/if}{/if}</td>
	...
	{if $user.show_toolbar==1}
		...
		<tr>
			...
			<td><a href="game.php?village={$village.id}&amp;screen=snob" ><img src="graphic/buildings/snob.png" alt="" />Pałac</a></td>
			<td><a href="game.php?village={$village.id}&amp;screen=smith" ><img src="graphic/buildings/smith.png" alt="" />Kuźnia</a></td>
	...
	<td><table class="box" cellspacing="0"><tr>
	<td width="18" height="20" align="center"><a href="game.php?village={$village.id}&amp;screen=farm"><img src="graphic/face.png" title="Wieśniak" alt="" /></a></td>
									...
									<tr id="menu_row">
										...
										<td class="menu-item">
											<a href="game.php?village={$village.id}&amp;screen=mail">
												{if $user.new_mail==1}<img src="graphic/new_mail.png" title="Nowa wiadomość" alt="" />{/if}
												Wiadomości
											</a>
										</td>
									...
									<td>
										<table class="box menu nowrap">
											<tr id="menu_row2">
												...
												<td class="box-item icon-box nowrap"><a href="game.php?village={$village.id}&amp;screen=snob" ><img src="graphic/buildings/snob.png" alt="" />Pałac</a></td>
												<td class="box-item icon-box nowrap"><a href="game.php?village={$village.id}&amp;screen=smith" ><img src="graphic/buildings/smith.png" alt="" />Kuźnia</a></td>
