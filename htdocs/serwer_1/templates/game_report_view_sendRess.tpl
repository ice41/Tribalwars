...
<h4>Surowce:</h4>
{if $report.wood>0}<img src="graphic/holz.png" title="Drewno" alt="" />{$report.wood} {/if}{if $report.stone>0}<img src="graphic/lehm.png" title="Glina" alt="" />{$report.stone} {/if}{if $report.iron>0}<img src="graphic/eisen.png" title="¯elazo" alt="" />{$report.iron} {/if}