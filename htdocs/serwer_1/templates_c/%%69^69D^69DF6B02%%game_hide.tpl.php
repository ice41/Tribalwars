<?php /* Smarty version 2.6.14, created on 2011-12-17 22:03:45
...
<?php if ($this->_tpl_vars['village'][$this->_tpl_vars['screen']] > 0): ?>
	<table class="vis">
		<?php $_from = $this->_tpl_vars['hide_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
.png" alt="" />
	...
	<table class="vis">
		...
		<tr>
			...
			<td>
				<img src="graphic/holz.png" title="Drewno" alt="" /> <?php echo $this->_tpl_vars['p_wood']; ?>

				<img src="graphic/lehm.png" title="Glina" alt="" /><?php echo $this->_tpl_vars['p_stone']; ?>

				<img src="graphic/eisen.png" title="¯elazo" alt="" /><?php echo $this->_tpl_vars['p_iron']; ?>
