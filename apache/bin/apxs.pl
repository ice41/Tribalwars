#!D:\servers\servers\tralha tribalwars\Empire of War\xampp\perl\bin\perl.EXE -w
# ====================================================================
#
...
my $CP    = 'D:\servers\servers\tralha tribalwars\Empire of War\xampp\perl\bin\perl.EXE -MExtUtils::Command -e cp';
my $CHMOD = 'D:\servers\servers\tralha tribalwars\Empire of War\xampp\perl\bin\perl.EXE -MExtUtils::Command -e chmod';
my $RM_F  = 'D:\servers\servers\tralha tribalwars\Empire of War\xampp\perl\bin\perl.EXE -MExtUtils::Command -e rm_f';
my $TOUCH = 'D:\servers\servers\tralha tribalwars\Empire of War\xampp\perl\bin\perl.EXE -MExtUtils::Command -e touch';
