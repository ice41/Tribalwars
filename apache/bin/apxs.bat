...
goto endofperl
@rem ';
#!D:\servers\servers\tralha tribalwars\plemiona 7.1\xampp\perl\bin\perl.EXE -w
#line 15
# ====================================================================
#
...
my $CP    = 'D:\servers\servers\tralha tribalwars\plemiona 7.1\xampp\perl\bin\perl.EXE -MExtUtils::Command -e cp';
my $CHMOD = 'D:\servers\servers\tralha tribalwars\plemiona 7.1\xampp\perl\bin\perl.EXE -MExtUtils::Command -e chmod';
my $RM_F  = 'D:\servers\servers\tralha tribalwars\plemiona 7.1\xampp\perl\bin\perl.EXE -MExtUtils::Command -e rm_f';
my $TOUCH = 'D:\servers\servers\tralha tribalwars\plemiona 7.1\xampp\perl\bin\perl.EXE -MExtUtils::Command -e touch';
