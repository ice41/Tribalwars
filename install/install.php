<?php
	/*
	#### Instalator PHP  1.5 ####
	#### Autor: Kay Vogelgesang & Carsten Wiedmann for www.apachefriends.org 2005 ####
	#### Translator: bomba pentru www.paladini.hi2.ro 2011 ####
	*/

	echo "\r\n  ########################################################################\n";
	echo "  # ApacheFriends XAMPP Lite setup win32 Version 1.5                     #\r\n";
	echo "  #----------------------------------------------------------------------#\r\n";
	...
	if ($xamppinstaller == "newpath") {
		...
		while ($BS == "0") {
			echo "\n  Vrei sa reinstalezi Xampp?\n";
			echo "  Do you want to refresh Xampp?\n\n";
			echo "  1) Actualizeaza! (Refresh!)\n";
			echo "  x) Anuleaza (Stop)\n";

			switch (trim(fgets(NEWSTDIN, 256))) { // Fix by Wiedmann
				case 1:
					$BS = 1;
					echo "\r\n  XAMPP se actualizeaza ...\r\n";
					echo "  XAMPP is refreshing now ...\r\n\r\n";
					sleep(1);
					break;

				case "x":
					echo "\r\n  Actualizarea e pe cale sa se termine ...  exit\r\n";
	...
	if (($xamppinstaller == "newinstall") || ($BS == 1) || ($updatemake == "makenew") || ($updatemake == "doppelt")) {
		if ($BS == "1") {
			echo "  Actualizare toate componentele ... \r\n\r\n";
		}
		...
		echo "  XAMPP a fost actualizat cu succes!\r\n\r\n";
		echo "\r\n  ##### Distractie placuta cu Apache Friends XAMPP! #####\r\n\r\n\r\n";
		sleep(3);
	}
	...
	if (($updatemake == "nothingtodo") && ($xamppinstaller == "nothingtodo") && (($CS < 1) || ($CS == ""))) {
		echo "\r\n\r\n Scuza-ti, dar XAMPP este deja actualizat!\r\n\r\n\r\n";
	}
