...
if ($do=="cancel_buddy"){
   ...
   if ($control_number==1){
      ...
      if ($control_number_block==0) {
         ...
         $title="Zosta³eœ usuniêty z listy przyjació³ $name_player";
...
if ($do=="reject_buddy"){
   ...
   if ($control_number==1){
      ...
      if ($control_number_block==0) {
         ...
         $title="Gracz $name_player nie zgodzi³ siê na do³¹czenie do Twojej listy przyjació³";
...
if ($do=="approve_buddy"){
   ...
   if ($control_number==1){
      ...
      $exec_sql2 = mysql_query($sql3) or die(mysql_error()); 
      $title="Gracz $name_player zgodzi³ siê na do³¹czenie do Twojej listy przyjació³";
...
if ($do=="delete_buddy"){
   ...
   if ($control_number==1){
      ...
      if ($control_number_block==0) {
         ...
         $title="Zosta³eœ usuniêty z listy przyjació³ $name_playert";
      ...
      if ($id_newfriend<>$id_player){
         ...
         if ($nr_result_ver==0) {
            ...
            if ($control_number_block==0) {
               ...
               $title="Propozycja zawarcia przyjaŸni od $name_player";
...
<h2>Przyjaciele</h2> 
<p>Tutaj mo¿esz zarz¹dzaæ Twoj¹ list¹ przyjació³ i miêdzy innymi mieæ mo¿liwoœæ sprawdzenia, kto jest online. Przyjmij do listy tylko tych graczy, którym ufasz, poniewa¿ oni te¿ widz¹ Twój status online. Wiadomoœæ ta mog³aby byæ bardzo cenna dla Twoich wrogów.</p> 
...
<h3>Moi przyjaciele</h3> 
<table class="vis"> 
<tr><th>Gracz</th><th>Status</th> 
<th>&#160;</th></tr> 
...
<tr> 
	...
	<td>{php}if ($online=='y') { echo '<center><img src="/ds_graphic/user_online.png" alt="online" title="online"></center>'; } elseif ($online=='n') { echo '<center><img src="/ds_graphic/user_offline.png" alt="offline" title="offline"></center>';}{/php}</td>
        <td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=delete_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Are you shure you want to delete this player from your friends list?')">Skasuj</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=cancel_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Are you shure you want to delete your request?')">Cofnij</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=approve_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Czy naprawdê chcesz zaakceptowaæ tê propozycjê?')">Akceptuj</a></td> 
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=reject_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Czy naprawdê chcesz odwo³aæ tê propozycjê?')">Odmów</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
