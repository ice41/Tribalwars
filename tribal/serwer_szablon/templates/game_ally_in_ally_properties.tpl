	...
	<tr>
		<td valign="top">
			{if $user.ally_found==1}
				...
				<table class="vis" width="100%">
					...
					<tr>
						<td><a href="javascript:ask('Czy chcesz na pewno rozwi¹zaæ w³asne plemiê?', 'game.php?village={$village.id}&amp;screen=ally&amp;mode=properties&amp;action=close_ally&amp;h={$hkey}')">Rozwi¹¿ plemiê</a></td>
					</tr>
				</table>
			{/if}
		...
		<td valign="top" width="400">
			{if $user.ally_diplomacy==1}
				...
				<form action="game.php?village={$village.id}&amp;screen=ally&amp;mode=properties&amp;action=change_description&amp;h={$hkey}" method="post" name="edit_profile">
					<table class="vis" width="100%">
						<tr>
