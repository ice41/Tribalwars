...
<table class="vis" width="100%">
	...
	<tr><td width="80">Punkty:</td><td>{$userInfoPoints}</td></tr>
	<tr><td>Ranking:</td><td>{$userInfoRang}</td></tr>
	<tr><td>Pokonani przeciwnicy:</td><td>{$userInfoKilledUnits} ({$userInfoKilledUnitsRang}.)</td></tr>
	<tr><td>Plemiê:</td><td><a href="guest.php?screen=info_ally&id={$userInfoAllyId}">{$userInfoAllyShort}</a></td>
	</tr>
...
<table class="vis" width="100%">
	<tr><th width="180">Wioski ({$userInfoVillagesNumRows})</th><th width="80">Wspó³rzêdne</th><th>P.</th></tr>
