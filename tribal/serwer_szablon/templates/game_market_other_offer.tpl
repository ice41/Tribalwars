...
<table class="vis">
	...
	{foreach from=$offers item=arr key=id}
		<tr>
			<td>
				{if $arr.sell_ress=='wood'}<img src="/ds_graphic/holz.png" title="Drewno" alt="" />{/if}{if $arr.sell_ress=='stone'}<img src="/ds_graphic/lehm.png" title="Glina" alt="" />{/if}{if $arr.sell_ress=='iron'}<img src="/ds_graphic/eisen.png" title="¯elazo" alt="" />{/if}{$arr.sell|format_number}
			</td>
			<td>
				{if $arr.buy_ress=='wood'}<img src="/ds_graphic/holz.png" title="Drewno" alt="" />{/if}{if $arr.buy_ress=='stone'}<img src="/ds_graphic/lehm.png" title="Glina" alt="" />{/if}{if $arr.buy_ress=='iron'}<img src="/ds_graphic/eisen.png" title="¯elazo" alt="" />{/if}{$arr.buy|format_number}
			</td>
			<td>
