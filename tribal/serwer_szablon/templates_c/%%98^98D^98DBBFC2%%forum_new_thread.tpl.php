<?php /* Smarty version 2.6.14, created on 2012-04-27 21:45:32
         compiled from forum/forum_new_thread.tpl */ ?>
...
" method="post" name="new_thread">
		<table class="vis" id="formTable">
			<tbody>
				<tr>
					<td>Temat:</td>
					<td><input name="subject" size="64" value="<?php echo $this->_tpl_vars['thread_name']; ?>
