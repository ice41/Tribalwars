<?php /* Smarty version 2.6.14, created on 2012-04-28 15:19:47
...
" enctype="multipart/form-data" method="post">
	<table class="vis" style="width: 100%; font-size: 12px !important;">
		...
		<tr>
			...
			<td>
				<input name="day" type="text" size="2" maxlength="2" value="<?php echo $this->_tpl_vars['settings']['b_day']; ?>
" />
                <select name="month">
					<option label="Styczeñ" value="1" <?php if ($this->_tpl_vars['settings']['b_month'] == 1): ?>selected<?php endif; ?>>Styczeñ</option>
					<option label="Luty" value="2" <?php if ($this->_tpl_vars['settings']['b_month'] == 2): ?>selected<?php endif; ?>>Luty</option>
					<option label="Marzec" value="3" <?php if ($this->_tpl_vars['settings']['b_month'] == 3): ?>selected<?php endif; ?>>Marzec</option>
					<option label="Kwiecieñ" value="4" <?php if ($this->_tpl_vars['settings']['b_month'] == 4): ?>selected<?php endif; ?>>Kwiecieñ</option>
					<option label="Maj" value="5" <?php if ($this->_tpl_vars['settings']['b_month'] == 5): ?>selected<?php endif; ?>>Maj</option>
					<option label="Czerwiec" value="6" <?php if ($this->_tpl_vars['settings']['b_month'] == 6): ?>selected<?php endif; ?>>Czerwiec</option>
					<option label="Lipiec" value="7" <?php if ($this->_tpl_vars['settings']['b_month'] == 7): ?>selected<?php endif; ?>>Lipiec</option>
					<option label="Sierpieñ" value="8" <?php if ($this->_tpl_vars['settings']['b_month'] == 8): ?>selected<?php endif; ?>>Sierpieñ</option>
					<option label="Wrzesieñ" value="9" <?php if ($this->_tpl_vars['settings']['b_month'] == 9): ?>selected<?php endif; ?>>Wrzesieñ</option>
					<option label="PaŸdziernik" value="10" <?php if ($this->_tpl_vars['settings']['b_month'] == 10): ?>selected<?php endif; ?>>PaŸdziernik</option>
					<option label="Listopad" value="11" <?php if ($this->_tpl_vars['settings']['b_month'] == 11): ?>selected<?php endif; ?>>Listopad</option>
					<option label="Grudzieñ" value="12" <?php if ($this->_tpl_vars['settings']['b_month'] == 12): ?>selected<?php endif; ?>>Grudzieñ</option>
				</select>
				<input name="year" type="text" size="4" maxlength="4" value="<?php echo $this->_tpl_vars['settings']['b_year']; ?>
" />
			</td>
		</tr>
		<tr>
			...
			<td>
			    <label>
					<input type="radio" name="sex" value="f" <?php if ($this->_tpl_vars['settings']['sex'] == 'f'): ?>checked="checked"<?php endif; ?> />
						¿eñska
				</label>
				<label>
					<input type="radio" name="sex" value="m" <?php if ($this->_tpl_vars['settings']['sex'] == 'm'): ?>checked="checked"<?php endif; ?> />
						mêska
				</label>
				<label>
					<input type="radio" name="sex" value="x" <?php if ($this->_tpl_vars['settings']['sex'] == 'x'): ?>checked="checked"<?php endif; ?> />
						nie podawaæ
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input name="home" type="text" size="24" maxlength="32" value="<?php echo $this->_tpl_vars['settings']['home']; ?>
" />
			</td>
		</tr>
		<tr>
...
<form action="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&screen=settings&mode=profile&action=change_text&h=<?php echo $this->_tpl_vars['hkey']; ?>
" method="POST"/>
	<table class="vis"/>
		<tr>
			<th colspan="2">Osobisty tekst:</th>
		</tr>
		<?php if (! empty ( $this->_tpl_vars['settings']['personal_text'] )): ?>
			<tr>
				<td>
					<?php echo $this->_tpl_vars['settings']['personal_text']; ?>
		...
		<tr>
			<td>
				<textarea id="message" name="text" tabindex="3" cols="50" rows="10"><?php echo $this->_tpl_vars['settings']['personal_text_bb']; ?>
</textarea>
			</td>
		</tr>
		<tr>
