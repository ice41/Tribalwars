...
" maxlength="50" class="answer" tabindex="3" type="text"><br>
				...
				<tr>
					<td></td>
					<td>
						<label><input name="show_result" tabindex="999" type="checkbox" <?php if ($this->_tpl_vars['show_result']): ?>checked="checked"<?php endif; ?>>Poka¿ wynik tak¿e tym graczom, którzy jeszcze nie g³osowali.</label>
					</td>
				</tr>
