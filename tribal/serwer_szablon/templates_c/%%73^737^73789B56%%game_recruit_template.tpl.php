<?php /* Smarty version 2.6.14, created on 2012-04-29 12:47:34
         compiled from game_recruit_template.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'format_time', 'game_recruit_template.tpl', 45, false),array('modifier', 'format_number', 'game_recruit_template.tpl', 101, false),)), $this); ?>
<?php 
...
.png" alt="" /> <?php echo $this->_tpl_vars['name']; ?>
					...
					<td><img src="/ds_graphic/holz.png" title="Drewno" alt="" /> <?php echo $this->_tpl_vars['cl_units']->get_woodprice($this->_tpl_vars['unit_dbname']); ?>
</td>
					<td><img src="/ds_graphic/lehm.png" title="Glina" alt="" /> <?php echo $this->_tpl_vars['cl_units']->get_stoneprice($this->_tpl_vars['unit_dbname']); ?>
</td>
					<td><img src="/ds_graphic/eisen.png" title="Ruda" alt="" /> <?php echo $this->_tpl_vars['cl_units']->get_ironprice($this->_tpl_vars['unit_dbname']); ?>
</td>
					<td><img src="/ds_graphic/face.png" title="Wieœniak" alt="" /> <?php echo $this->_tpl_vars['cl_units']->get_bhprice($this->_tpl_vars['unit_dbname']); ?>
</td>
