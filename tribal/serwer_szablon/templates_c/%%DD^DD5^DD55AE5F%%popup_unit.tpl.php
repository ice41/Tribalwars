<?php /* Smarty version 2.6.14, created on 2012-03-11 13:13:13
						...
						<tr>
							<td>
								<table>
									<tr>
										<td>
											<img src="graphic/unit_big/<?php echo $this->_tpl_vars['cl_units']->get_graphicName($this->_tpl_vars['unit']); ?>
...
" />
								...
								<table class="vis">
									...
									<tr class="center">
										<td>
											<img src="graphic/holz.png" title="Drewno" alt="" /><?php echo $this->_tpl_vars['cl_units']->get_woodprice($this->_tpl_vars['unit']); ?>
 
											<img src="graphic/lehm.png" title="Glina" alt="" /><?php echo $this->_tpl_vars['cl_units']->get_stoneprice($this->_tpl_vars['unit']); ?>
 
											<img src="graphic/eisen.png" title="Żelazo" alt="" /><?php echo $this->_tpl_vars['cl_units']->get_ironprice($this->_tpl_vars['unit']); ?>
 
										</td>
										<td>
											<img src="graphic/face.png" title="Wieśniak" alt="" /> <?php echo $this->_tpl_vars['cl_units']->get_bhprice($this->_tpl_vars['unit']); ?>
 ...
 Minut na pole
								...
								<table class="vis">
									<tr>
										<td>Siła ataku</td>
										<td>
											<img src="graphic/unit/att.png" alt="Siła ataku" /> <?php echo $this->_tpl_vars['cl_units']->get_att($this->_tpl_vars['unit'],1); ?>
									...
									<tr>
										<td>Siła obrony</td>
										<td>
											<img src="graphic/unit/def.png" alt="Siła obrony" /> <?php echo $this->_tpl_vars['cl_units']->get_def($this->_tpl_vars['unit'],1); ?>
									...
									<tr>
										...
										<td>
											<img src="graphic/unit/def_cav.png" alt="Siła obrony przeciw kawalerii" /> <?php echo $this->_tpl_vars['cl_units']->get_defCav($this->_tpl_vars['unit'],1); ?>
</td>
									</tr>
									<tr>
										<td>Siła obrony przeciw łucznikom</td>
										<td><img src="graphic/unit/def_archer.png" alt="Siła obrony przeciw łucznikom" /> <?php echo $this->_tpl_vars['cl_units']->get_defArcher($this->_tpl_vars['unit'],1); ?>
</td>
									</tr>
							</table>
