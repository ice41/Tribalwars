<?php /* Smarty version 2.6.14, created on 2012-04-29 12:49:46
				...
				<div id="replace_snob">
					<?php if ($this->_tpl_vars['first_unit']['is']): ?>
						<table class="vis">
							<tbody>
								<tr>
									<th width="250">Zakoñczenie szkolenia nastêpnej jednostki (<?php echo $this->_tpl_vars['first_unit']['unitname']; ?>
):</th>
...
.png" alt="" /> <?php echo $this->_tpl_vars['name']; ?>
						...
						<td><img src="/ds_graphic/holz.png" title="Holz" alt="" /> <?php if ($this->_tpl_vars['village']['r_wood'] >= $this->_tpl_vars['cl_units']->get_woodprice($this->_tpl_vars['unit_dbname'])):  echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_woodprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp));  else: ?><font color="red"><?php echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_woodprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</font><?php endif; ?></td>
						<td><img src="/ds_graphic/lehm.png" title="Lehm" alt="" /> <?php if ($this->_tpl_vars['village']['r_stone'] >= $this->_tpl_vars['cl_units']->get_stoneprice($this->_tpl_vars['unit_dbname'])):  echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_stoneprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp));  else: ?><font color="red"><?php echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_stoneprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</font><?php endif; ?></td>
						<td><img src="/ds_graphic/eisen.png" title="Eisen" alt="" /> <?php if ($this->_tpl_vars['village']['r_iron'] >= $this->_tpl_vars['cl_units']->get_ironprice($this->_tpl_vars['unit_dbname'])):  echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_ironprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp));  else: ?><font color="red"><?php echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_ironprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</font><?php endif; ?></td>
						<td><img src="/ds_graphic/face.png" title="Arbeiter" alt="" /> <?php if ($this->_tpl_vars['max_bh'] - $this->_tpl_vars['village']['r_bh'] >= $this->_tpl_vars['cl_units']->get_bhprice($this->_tpl_vars['unit_dbname'])):  echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_bhprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp));  else: ?><font color="red"><?php echo ((is_array($_tmp=$this->_tpl_vars['cl_units']->get_bhprice($this->_tpl_vars['unit_dbname']))) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</font><?php endif; ?></td>
...
');return false;">
								...
								<?php endif; ?>
							<?php else: ?>
								<td class="inactive">Zagroda nie mo¿e wy¿ywiæ dalszych jednostek</td>
							<?php endif; ?>
						<?php else: ?>
		...
		<?php if ($this->_tpl_vars['ag_style'] == 0): ?>
			...
			<table class="vis">
				<tr><td>Poziom szlachty:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['snobs_stage'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</td></tr>
				<tr><td>- Szlachcice dostêpni:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['snobs_dostepne'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</td></tr>
				<tr><td>- Szlachcice w produkcji:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['snobs_produkcja'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</td></tr>
				<tr><td>- Szlachcice osadzenie w wioskach:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['snobs_in_vgs'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</td></tr>
				<tr><th>Mo¿na wyprodukowaæ:</th><th><?php echo ((is_array($_tmp=$this->_tpl_vars['snobs_canpr'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
</th></tr>
			</table>
		<?php elseif ($this->_tpl_vars['ag_style'] == 1): ?>
			...
			<table>
				<tbody>
					<tr>
						<td>
							<img alt="Moneta" src="/ds_graphic/gold_big.png" />
						</td>
						<td>
							<h4>Z³ote monety</h4>
			...
			<table class="vis">
				<tbody>
					...
					<tr>
						<td>
							<img alt="" title="Drewno" src="/ds_graphic/holz.png"/>
							...
							<img alt="" title="Glina" src="/ds_graphic/lehm.png"/>
							...
							<img alt="" title="Ruda" src="/ds_graphic/eisen.png"/>
...
?>
					<tr<?php if ($this->_tpl_vars['wioska']['id'] == $this->_tpl_vars['village']['id']): ?> class="selected"<?php else:  if (! $this->_tpl_vars['wioska']['parzysta_liczba']): ?> class="row_b"<?php else: ?> class="row_a"<?php endif;  endif; ?>>
						<td width="300">
...
|<?php echo $this->_tpl_vars['wioska']['y']; ?>
						...
						<td width="120">
							<img src="/ds_graphic/wood.png" title="Drewno"/>&nbsp;
...
');return false;">
 ...
 <img alt="Moneta" src="/ds_graphic/gold.png" style="position: relative;top: 3px;"/>)
						</span>
						</td>
					</tr>
				<?php endforeach; endif; unset($_from); ?>
				<td style="height:24px;" align="left">
					<span onclick="selectCoiningNoneMax('Wybierz maksymaln¹ liczbê', 'Odznacz wszystko');return false;">
