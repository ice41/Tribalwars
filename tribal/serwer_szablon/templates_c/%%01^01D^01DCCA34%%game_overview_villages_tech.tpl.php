<?php /* Smarty version 2.6.14, created on 2012-04-28 15:22:19
         compiled from game_overview_villages_tech.tpl */ ?>
...
?>
			<th width="40"><img src="/ds_graphic/unit/unit_<?php echo $this->_tpl_vars['dbname']; ?>
.png" title="<?php echo $this->_tpl_vars['cl_techs']->get_name($this->_tpl_vars['dbname']); ?>
" alt="<?php echo $this->_tpl_vars['cl_techs']->get_name($this->_tpl_vars['dbname']); ?>
"/></th>
		<?php endforeach; endif; unset($_from); ?>
		<th width="150">Badanie</th>
	</tr>
...
|<?php echo $this->_tpl_vars['villages'][$this->_tpl_vars['arr_id']]['y']; ?>
			...
			<td>
				<img src="/ds_graphic/overview/research.png" alt="Punkty badañ" title="Punkty badañ"/> 
				<?php echo $this->_tpl_vars['id']['points_min']; ?>
/<?php echo $this->_tpl_vars['id']['points_max']; ?>

			</td>
			<?php $_from = $this->_tpl_vars['cl_techs']->get_array('dbname'); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['dbname']):
?>
				<?php if ($this->_tpl_vars['id']['techs'][$this->_tpl_vars['dbname']] > 0): ?>
					<td><?php echo $this->_tpl_vars['id']['techs'][$this->_tpl_vars['dbname']]; ?>
</td>
				<?php else: ?>
					<td class="hidden"><?php echo $this->_tpl_vars['id']['techs'][$this->_tpl_vars['dbname']]; ?>
</td>
				<?php endif; ?>
			<?php endforeach; endif; unset($_from); ?>
			<td>
				<?php $_from = $this->_tpl_vars['id']['research_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tech']):
?>
					<img src="/ds_graphic/unit/unit_<?php echo $this->_tpl_vars['tech']; ?>
.png" title="<?php echo $this->_tpl_vars['cl_techs']->get_name($this->_tpl_vars['tech']); ?>
" alt=""/>
				<?php endforeach; endif; unset($_from); ?>
			</td>
		</tr>
