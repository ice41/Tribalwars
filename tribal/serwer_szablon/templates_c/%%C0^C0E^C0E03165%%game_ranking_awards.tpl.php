<?php /* Smarty version 2.6.14, created on 2012-02-12 10:01:02
         compiled from game_ranking_awards.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'format_number', 'game_ranking_awards.tpl', 30, false),)), $this); ?>
	...
	<div>				
		<table id="player_ranking_table" class="vis" width="100%">
			<tbody>
				...
				<?php $_from = $this->_tpl_vars['user_award_rangs']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
">
						...
						<td class="lit-item">
							<?php echo $this->_tpl_vars['userinfo']['awards']; ?>
					...
					<tr>
						<?php if ($this->_tpl_vars['aktu_page_ra'] > 0): ?>
							<td align="center" width="50%">
								<a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ranking&amp;mode=awards&amp;page=<?php echo $this->_tpl_vars['aktu_page_ra']-1; ?>
">&lt;&lt;&lt; do góry</a>
							</td>
						<?php endif; ?>
						<td align="center" width="50%">
...
&amp;screen=ranking&amp;mode=awards" method="post">
