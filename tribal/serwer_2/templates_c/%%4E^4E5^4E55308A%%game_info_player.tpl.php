<?php /* Smarty version 2.6.14, created on 2014-07-03 03:08:50
...
<table class="vis" width="100%">
	...
	<tr><td>Posição:</td><td><?php echo $this->_tpl_vars['info_user']['rang']; ?>
</td></tr>
...
">&raquo; Marcar no mapa</a></td></tr>
		<?php endif; ?>
		<?php if ($this->_tpl_vars['can_invite']): ?>
			<tr><td colspan="2"><a href="javascript:ask('Quer convidar <?php echo $this->_tpl_vars['info_user']['username']; ?>
 para a tribo?', 'game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
<table class="vis" width="100%">
	<tr><th width="180">Aldeias (<?php echo $this->_tpl_vars['user']['villages']; ?>
)</th><th width="80">Coordenadas</th><th>Pontos</th></tr>
...
" /></td></tr>
	...
	<?php if ($this->_tpl_vars['info_user']['home'] != ''): ?>
		<tr><td>Residência:</td><td><?php echo $this->_tpl_vars['info_user']['home']; ?>
</td></tr>
	<?php endif; ?>
