...
?>
		<?php if ($this->_tpl_vars['user']['aktu_group'] === $this->_tpl_vars['group']): ?>
			<strong class="group_tooltip">&gt;<?php if ($this->_tpl_vars['group'] == 'all'): ?>tudo<?php else:  echo $this->_tpl_vars['group'];  endif; ?>&lt; </strong>
		<?php else: ?>
...
">[<?php if ($this->_tpl_vars['group'] == 'all'): ?>tudo<?php else:  echo $this->_tpl_vars['group'];  endif; ?>]</a>
		<?php endif; ?>
