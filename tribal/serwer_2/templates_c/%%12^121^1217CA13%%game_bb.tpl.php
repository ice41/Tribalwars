<?php /* Smarty version 2.6.14, created on 2012-02-19 12:11:29
         compiled from game_bb.tpl */ ?>
<?php if (! empty ( $this->_tpl_vars['effect_test'] )): ?>
	<?php echo $this->_tpl_vars['effect_test']; ?>
...
&screen=bb&a=test" method="POST"/>
	<table class="vis"/>
		...
		<tr>
			<td>
				<textarea id="message" name="text" tabindex="3" cols="70" rows="16"></textarea>
			</td>
		</tr>
		<tr>
			<td>
				<input type="submit" name="zatwierdz" value="Podgl¹d"/>
			</td>
		</tr>
	</table>
</form>