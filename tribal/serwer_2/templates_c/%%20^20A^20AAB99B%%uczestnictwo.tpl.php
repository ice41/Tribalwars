<?php /* Smarty version 2.6.14, created on 2014-07-03 02:37:58
...
<font color="#9933CC">Estilo 4.0 (wioski koczownicze,<?php if ($this->_tpl_vars['monety']): ?>monety<?php endif;  if ($this->_tpl_vars['poziom_pałacu']): ?>Pałac ma 3 poziomy<?php endif; ?>, łucznicy, łucznicy konni, rycerz z przedmiotami,<b>bez kościoła</b>)</font><br>

noite: o bônus de noite<br><font color="red">Velocidade: <?php echo $this->_tpl_vars['speed']; ?>
</font>
</td></tr></table>

<?php if ($this->_tpl_vars['rejestracja_nowych_graczy']): ?>
<p>Quer participar no  <strong>Mundo <?php echo $this->_tpl_vars['serwer']; ?>
</strong>?</p>
