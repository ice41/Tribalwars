<?php /* Smarty version 2.6.14, created on 2014-07-03 03:36:19
...
" alt="" /></th>
	...
	<tr><td>IloϾ:</td><?php $_from = $this->_tpl_vars['report_units']['units_a']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
