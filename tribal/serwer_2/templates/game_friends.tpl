...
<h2>Amigos</h2> 
<p>Mantenha-se a par dos seus amigos ao adiciona-los à sua lista. Tenha atenção que aceitar pedidos de outros jogadores implica que eles podem saber quando está online.</p> 
...
<h3>Nossa própria marca</h3> 
<table class="vis"> 
<tr><th>Jogador</th><th colspan="2">Acção</th></tr> 
{php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=cancel_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Are you shure you want to delete your request?')">Voltar</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
