	...
	<tr>
		...
		<td valign="top" width="400">
			<table class="vis" width="100%">
				<tr>
					<td>
						<a href="game.php?village={$village.id}&amp;screen=ally&amp;action=exit&amp;h={$kkey}" onclick="javascript:ask('Czy na prawdê chcesz opuœciæ plemiê', 'game.php?village={$village.id}&amp;screen=ally&amp;action=exit&amp;h={$hkey}'); return false;">
							Opuœæ plemiê
						</a>
					</td>
				</tr>
			...
			<form action="game.php?village={$village.id}&amp;screen=ally&amp;action=edit_intern_text&amp;h={$hkey}" method="post" name="edit_profile">
