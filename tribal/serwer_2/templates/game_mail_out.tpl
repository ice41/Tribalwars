{if empty($view)}
	...
	{/if}
	<tr><th>Assunto</th><th width="160">Remetente</th><th width="140">Data</th></tr>
...
{else}
	{if empty($error)}
		...
		<td align="center" width="120"><a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=new&amp;reply={$mail.id}&amp;type=out">Responder</a></td>
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=new&amp;reply={$mail.id}&amp;type=out&amp;forward=true">Reencaminhar</a></td>
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;action=arch&amp;id={$mail.id}&amp;mode=out&amp;h={$hkey}">Arquivar</a></td>
		<td align="center" width="25%"><a href="game.php?village={$village.id}&amp;screen=mail&amp;action=del&amp;id={$mail.id}&amp;mode=out&amp;h={$hkey}">Exportar</a></td>
		</tr>
		</table>
		...
		<td align="center"><a href="game.php?village={$village.id}&amp;screen=mail&amp;mode=block&amp;action=block_id&amp;id={$mail.from_id}&amp;h={$hkey}&amp;mode=out">Bloquear remetente</a></td>
		</tr>
		</table><br />
	{/if}
{/if}