...
KAMap.prototype.tooltipDetails = function(village_id, village_name, points, owner, ally, moral, groups, runtimes, ressis, settlers, mules, units, isProtectedFromAttacks, isProtectedFromEnnoblings, BonusText, BonusImage) {
    ...
    if (ressis) {
        ...
        code += '<td><img src="/ds_graphic/wood.png" /></td><td>' + ress[0] + '</td>';
        code += '<td><img src="/ds_graphic/stone.png" /></td><td>' + ress[1] + '</td>';
        code += '<td><img src="/ds_graphic/iron.png" /></td><td>' + ress[2] + '</td>';
        code += '<td><img src="/ds_graphic/res.png" /></td><td>' + ress[3] + '</td>';
        code += '</tr></table>';
        code += '</td></tr>';
    }
    ...
    if (settlers) {
        ...
        if (settlers) {
            code += '<td><img src="/ds_graphic/face.png" /></td><td>' + settlers + '</td>';
        }
