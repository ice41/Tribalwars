...
<h2>Continente {$mapa.kontynent}</h2>
...
<td style="padding: 0px; width: 15px; min-width: 15px; background-color: rgb(255, 255, 255);"></td><td class="small" style="white-space: normal;">Selecionado</td>

<td style="padding: 0px; width: 15px; min-width: 15px; background-color: rgb(240, 200, 0);"></td><td class="small" style="white-space: normal;">A sue própria aldeia</td>
<td style="padding: 0px; width: 15px; min-width: 15px; background-color: rgb(0, 0, 244);"></td><td class="small" style="white-space: normal;">Sua própria tribo</td>
<td style="padding: 0px; width: 15px; min-width: 15px; background-color: rgb(150, 150, 150);"></td><td class="small" style="white-space: normal;">Aldeias abandonadas</td>
<td style="padding: 0px; width: 15px; min-width: 15px; background-color: rgb(130, 60, 10);"></td><td class="small" style="white-space: normal;">Outros</td>
</tr>

<tr class="nowrap">
<td class="small" valign="top">Tribos:</td>
...
<td style="padding: 0px; width: 15px; min-width: 15px; background-color: rgb(128, 0, 128);"></td><td class="small" style="white-space: normal;">Pactos de não agreção</td>
...
{if count($odznaczeni) > 0}
	<tr class="nowrap">
		<td class="small" valign="top" colspan="6">Nossas próprias distinções:</td>
	</tr>
...
<a href="game.php?village={$village.id}&screen=edytuj_kolory_graczy"/>&raquo; Emblemas editados jogadores</a>
		...
		<td valign="top" style="padding: 0px 10px;">
			...
			<form action="game.php?village={$village.id}&screen=map&action=save_map_options" method="POST">
				<table class="vis padding2" width="100%">
					<tr>
						<th><b>Opções de mapa pop-up:</b></th>
					</tr>
