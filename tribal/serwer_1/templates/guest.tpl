...
<table class="vis">
<tr>
<td class="selected"><a href="?screen=ranking">Ranking</a></td>
</tr>
</table>
...
<table class="vis">
<tr><td width="100"><a href="guest.php?screen=ranking&amp;mode=ally">Plemiona</a></td></tr>

<tr>
  <td class="selected" width="100"><a href="guest.php?screen=ranking&amp;mode=player">Gracz</a></td>
</tr>
</table>

</td><td valign="top"><table class="vis">
<tr><th width="60">Ranking</th><th width="180">Nazwa</th>
<th width="60">Plemi�</th>
<th width="60">P.</th><th>Wioski</th><th>�rednia punkt�w na wiosk�</th></tr>
