...
{if $noob}
	<span class="error">Este jogador estará protegido contra os ataques até {$noob_end}.</span>
{/if}
	...
	<tr>
		<td valign="top">
			<table class="vis">
				...
				<tr>
					<td colspan="2"><a href="game.php?village={$village.id}&amp;screen=map&amp;x={$info_village.x}&amp;y={$info_village.y}">&raquo; Centralizar mapa</a></td>
				</tr>
				<tr>
				...
				{if $can_res}
					<tr>
						<td colspan="2"><a href="game.php?village={$village.id}&screen=ally&mode=reservations&amp;x={$info_village.x}&amp;y={$info_village.y}">&raquo; Reservar</a></td>
					</tr>
				{/if}
				{if $user.id==$info_village.userid}
					<tr>
						<td colspan="2"><a href="game.php?village={$info_village.id}&amp;screen=overview">&raquo; Reservar</a></td>
					</tr>
				{/if}
				{if $mozna_lubiec}
					<tr>
