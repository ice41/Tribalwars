	...
	<tr>
		...
		<td valign="top" width="400">
			<table class="vis" width="100%">
				<tr>
					<td>
						<a href="game.php?village={$village.id}&amp;screen=ally&amp;action=exit&amp;h={$kkey}" onclick="javascript:ask('Realmente quer sair da Tribo', 'game.php?village={$village.id}&amp;screen=ally&amp;action=exit&amp;h={$hkey}'); return false;">
							Abandonar a Tribo
						</a>
					</td>
				</tr>
