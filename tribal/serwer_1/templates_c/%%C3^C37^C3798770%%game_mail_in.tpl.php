<?php /* Smarty version 2.6.14, created on 2013-12-24 15:42:12
...
</a><?php if ($this->_tpl_vars['arr']['is_read'] == 0): ?> (nowa)<?php endif;  if ($this->_tpl_vars['arr']['is_answered'] == 1): ?> <span class="inactive"> (Nie przeczytane)</span><?php endif; ?></td>
...
<?php else: ?>
	<?php if (empty ( $this->_tpl_vars['error'] )): ?>
		...
		<td align="center" width="120"><?php if ($this->_tpl_vars['mail']['from_id'] == -1): ?>Odpisz<?php else: ?><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
">Usuñ</a></td>
		...
		<tr><td>Odbiorca</td><td><?php if ($this->_tpl_vars['mail']['from_id'] == -1):  echo $this->_tpl_vars['mail']['from_username'];  else: ?><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
">Usuñ</a></td>
		...
		<td align="center"><?php if ($this->_tpl_vars['mail']['from_id'] == -1): ?>Zablokuj nadawcê<?php else: ?><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail&amp;mode=block&amp;action=block_id&amp;id=<?php echo $this->_tpl_vars['mail']['from_id']; ?>
&amp;h=<?php echo $this->_tpl_vars['hkey']; ?>
">Zablokuj nadawcê</a><?php endif; ?></td>
		</tr>
		</table><br />
	<?php endif; ?>
<?php endif; ?>