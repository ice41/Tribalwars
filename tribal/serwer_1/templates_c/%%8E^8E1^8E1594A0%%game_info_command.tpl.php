<?php /* Smarty version 2.6.14, created on 2014-07-03 02:44:59
...
"><?php echo $this->_tpl_vars['mov']['to_username']; ?>
		...
		<tr><td>Duração:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['duration'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</td></tr>
		<tr><td>Chegada:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['arrival'])) ? $this->_run_mod_handler('format_date', true, $_tmp) : format_date($_tmp)); ?>
</td></tr>
		<tr><td>Regresso em:</td><td><span class="timer"><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['arrival_in'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</span></td></tr>
...
" alt="" /></th>
 ...
 if ($this->_tpl_vars['num_units'] > 0): ?><td><?php echo ((is_array($_tmp=$this->_tpl_vars['num_units'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
		...
		<?php if ($this->_tpl_vars['mov']['wood'] != 0 || $this->_tpl_vars['mov']['stone'] != 0 || $this->_tpl_vars['mov']['iron'] != 0): ?>
			<table class="vis"><tr>
			<td>£upy:</td><td><?php if ($this->_tpl_vars['mov']['wood'] > 0): ?><img src="/ds_graphic/holz.png" title="Madeira" alt="" /><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['wood'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
 <?php endif;  if ($this->_tpl_vars['mov']['stone'] > 0): ?><img src="/ds_graphic/lehm.png" title="Argila" alt="" /><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['stone'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
 <?php endif;  if ($this->_tpl_vars['mov']['iron'] > 0): ?><img src="/ds_graphic/eisen.png" title="Ferro" alt="" /><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['iron'])) ? $this->_run_mod_handler('format_number', true, $_tmp) : format_number($_tmp)); ?>
 <?php endif; ?></td>
			</tr></table>
		<?php endif; ?>
	<?php else: ?>
...
"><?php echo $this->_tpl_vars['mov']['from_username']; ?>
		...
		<tr><td>Retorno:</td><td><span class="timer"><?php echo ((is_array($_tmp=$this->_tpl_vars['mov']['arrival_in'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</span></td></tr>
		</table>	
	<?php endif; ?>
<?php else: ?>
