<?php /* Smarty version 2.6.14, created on 2016-12-21 01:35:33
...
?>
			<tr>
				<td width="200">
					<img src="/ds_graphic/<?php echo $this->_tpl_vars['sur_name']; ?>
.png" alt="" />
	...
	<table class="vis">
		<tr>
			<td width="60%">
				Iloœæ surowców wyprodukowanych do tej pory.:
			</td>
			<td>
				od: <?php echo $this->_tpl_vars['time_last_rel']; ?>
 (<?php echo $this->_tpl_vars['day_last_rel']; ?>
 <?php if ($this->_tpl_vars['day_last_rel'] == 1): ?>Dzieñ<?php else: ?>Dni<?php endif; ?>)
			</td>
			<td>
				<img src="/ds_graphic/<?php echo $this->_tpl_vars['sur_name']; ?>
